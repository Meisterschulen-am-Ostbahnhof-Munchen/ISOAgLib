 ...
 *     conf_0_1_AddressClaimDin from the directory where the spec file
 *     and the script are located<br>
 *     <i>#> update_makefile.sh conf_0_1_AddressClaimDin</i>
 * <li><b>Only Linux:</b><ul>
 *     <li><i>#>cd 0_1_AddressClaimDin</i> to go to the subdirectory 0_1_AddressClaimDin
 *     <li><i>#> make</i><br>
 *     <li>GNU make will then use the fresh created Makefile to create the executable 0_1_AddressClaimDin in this directory
 *     </ul>
 * <li><b>Other Development Environments:</b><ul>
 *     <li>import the file list in filelist-0_1_AddressClaimDin.txt into the IDE of your choice
 *     <li>set <i>-DPRJ_USE_AUTOGEN_CONFIG=config_0_1_AddressClaimDin</i> as global project parameter
 ...
 * \ref PrjSpec0_1_AddressClaimDin__pc_linux__simulating__simulating .
 *
 * The adopted project specifications for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__rte__rte
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__rte__simulating
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__rte__sys
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__simulating__rte
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__simulating__simulating
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_linux__simulating__sys
 *	</ul>
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__vector_canlib__simulating
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__vector_xl_drv_lib__simulating
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__vector_canlib__sys
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__vector_xl_drv_lib__sys
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__simulating__simulating
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pc_win32__simulating__sys
 * 	</ul>
 * <li>Configuration Setupts for some embedded targets:
 * <ul>
 *		<li> \ref PrjSpec0_1_AddressClaimDin__esx__sys__sys
 *		<li> \ref PrjSpec0_1_AddressClaimDin__imi__sys__sys
 *		<li> \ref PrjSpec0_1_AddressClaimDin__pm167__sys__sys
 *	</ul>
 * </ul>
 *
 * <H1>Resulting Project File List</H1>
 * See \ref FileLists0_1_AddressClaimDin__pc_linux__simulating__simulating for needed files
 * ( filelist-0_1_AddressClaimDin-doxygen_import.txt ),
 *  with \ref SrcList0_1_AddressClaimDin__pc_linux__simulating__simulating containing the needed sources
 *  and with \ref HdrList0_1_AddressClaimDin__pc_linux__simulating__simulating containing the needed headers.
 *
 * The resulting file lists for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__rte__rte
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__rte__simulating
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__rte__sys
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__simulating__rte
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__simulating__simulating
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_linux__simulating__sys
 *	</ul>
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__vector_canlib__simulating
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__vector_xl_drv_lib__simulating
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__vector_canlib__sys
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__vector_xl_drv_lib__sys
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__simulating__simulating
 *		<li> \ref FileLists0_1_AddressClaimDin__pc_win32__simulating__sys
 * 	</ul>
 * <li>Configuration Setupts for some embedded targets:
 * <ul>
 *		<li> \ref FileLists0_1_AddressClaimDin__esx__sys__sys
 *		<li> \ref FileLists0_1_AddressClaimDin__imi__sys__sys
 *		<li> \ref FileLists0_1_AddressClaimDin__pm167__sys__sys
 *	</ul>
 * </ul>
 *
...
/** the define PRJ_USE_AUTOGEN_CONFIG is used by xgpl_src/Application_Config/isoaglib_config.h
	...
	*/
	...
	#define PRJ_USE_AUTOGEN_CONFIG config_0_1_AddressClaimDin.h
#endif
