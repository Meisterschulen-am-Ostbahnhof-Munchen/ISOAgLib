...
/**
  ...
  IsoAgLib::iGetyPos_c c_myType( 2, 0 );
  // ...
  // now start as DIN
...
public:
  ...
  */
  ...
  /**
    ...
    @param ri_singletonVecKey optional key for selection of IsoAgLib instance (default 0)
  */
  void start(iGetyPos_c* rpc_gtp = NULL,
      const uint8_t* rpb_name = NULL,
      int ri_singletonVecKey = 0
      ) { IdentItem_c::start(rpc_gtp, rpb_name, ri_singletonVecKey);};
#endif
#ifdef USE_ISO_11783
  ...
  */
  const iGetyPos_c& gtp() const {return static_cast<const iGetyPos_c&>(IdentItem_c::gtp());};
 private:
