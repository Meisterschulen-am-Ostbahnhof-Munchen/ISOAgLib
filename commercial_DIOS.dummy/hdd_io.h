/***************************************************************************
                          hdd_io.h  -  header for Hdd_IO object
...
namespace HwHdd {
/* please contact company CSM because the source code of the controller
   for the CSM DOS DRIVE depends on a NDA */
}
} // end of namespace __IsoAgLib::HwHdd
