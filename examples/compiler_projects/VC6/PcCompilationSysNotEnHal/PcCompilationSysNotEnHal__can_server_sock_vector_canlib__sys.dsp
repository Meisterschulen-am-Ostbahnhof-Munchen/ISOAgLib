...
# ADD CPP /nologo /W3 /GX /O2 /I "C:\STLport\stlport" /I "..\..\..\.." /I "..\..\..\..\library\xgpl_src" /I "C:\Development\CANLIB\dll" /I "..\..\..\..\examples\src\GeneralTest\PcCompilation" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /D "SYSTEM_PC_VC" /D "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /D "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION /YX /FD /TP /c
# ADD BASE RSC /l 0x407 /d "NDEBUG" /d "SYSTEM_PC_VC" /d "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /d "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION
# ADD RSC /l 0x407 /d "NDEBUG" /d "SYSTEM_PC_VC" /d "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /d "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION
BSC32=bscmake.exe
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "C:\STLport\stlport" /I "..\..\..\.." /I "..\..\..\..\library\xgpl_src" /I "C:\Development\CANLIB\dll" /I "..\..\..\..\examples\src\GeneralTest\PcCompilation" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS"  /D "SYSTEM_PC_VC" /D "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /D "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION /YX /FD /TP /GZ /c
# ADD BASE RSC /l 0x407 /d "_DEBUG" /d "SYSTEM_PC_VC" /d "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /d "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION
# ADD RSC /l 0x407 /d "_DEBUG" /d "SYSTEM_PC_VC" /d "PRJ_USE_AUTOGEN_CONFIG=config_PcCompilationSysNotEnHal.h" /d "HWTYPE_VIRTUAL" /D DEBUG /D ALLOW_PROPRIETARY_MESSAGES_ON_STANDARD_PROTOCOL_CHANNEL /D USE_CAN_SEND_DELAY_MEASUREMENT /D PROCESS_INVALID_PACKETS /D ENABLE_NMEA_2000_MULTI_PACKET /D ENABLE_MULTIPACKET_VARIANT_FAST_PACKET /D USE_CAN_MEASURE_BUSLOAD /D DEBUG_CAN_BUFFER_FILLING /D CONFIG_CAN_FIFO_READ_WAITING /D DEBUG_CAN_FILTERBOX_MSGOBJ_RELATION
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
