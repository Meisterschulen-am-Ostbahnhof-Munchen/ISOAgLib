// File: config_3_2_VirtualTerminalMultiIso.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_3_2_VirtualTerminalMultiIso" 
//            Perform changes direct in the feature and project setup file conf_3_2_VirtualTerminalMultiIso
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_3_2_VirtualTerminalMultiIso" call,
...
/** allow configuration by parameter value NO */
  ...
  #define NO 0
	...
	#define PRJ_ISO_TERMINAL_OBJECT_SELECTION1 MaskDefinition1/simpleVTIsoPool-objectselection.inc 
#endif
#ifndef PRJ_ISO_TERMINAL_OBJECT_SELECTION2 
	#define PRJ_ISO_TERMINAL_OBJECT_SELECTION2 MaskDefinition2/simpleVTIsoPool2-objectselection.inc 
#endif
