 ...
 * <ol>
 * <li> This example ("2_9_RemoteWriteSetpointStdIso") shows how to send 
 * setpoints to distant processes and demonstrates the optional usage 
 * of a handler class with a method which is automatically called on each 
 * setpoint response receive. An example for data provisioning can be
 * fount in 2_4_LocalWriteSetpointStdIso. Important used concepts are:
 * <ul>
 ...
 *     <li>import the file list in filelist__2_9_RemoteWriteSetpointStdIso.txt into the IDE of your choice
 ...
 * <ul>
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__rte
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__rte
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__sys
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__sys
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__sys
 ...
 * <ul>
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_xl__simulating
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref PrjSpec2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_xl__sys
 ...
 * ( filelist__2_9_RemoteWriteSetpointStdIso.txt ),
 ...
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__rte
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__rte
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_rte__sys
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_A1__sys
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_linux__msq_server_pcan__sys
 ...
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_xl__simulating
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref FileLists2_9_RemoteWriteSetpointStdIso__pc_win32__can_server_sock_vector_xl__sys
...
class MyProcDataHandler_c : public IsoAgLib::ProcessDataChangeHandler_c
{
  public:
    /** react on received setpoint ACK or NACK upon previous setpoint set for remote process data
      ...
      */
    virtual bool processSetpointResponse( EventSource_c ac_src, int32_t ai32_val, const IsoAgLib::iIsoName_c& ac_callerISOName );
};

bool MyProcDataHandler_c::processSetpointResponse( EventSource_c ac_src, int32_t /* ai32_val */, const IsoAgLib::iIsoName_c& /* ac_callerISOName */ )
{
...
void controlRemoteWorkState( bool ab_isWorking )
{
  ...
  if ( ab_isWorking ) c_workState.setSetpointMasterVal( 100 );
  else c_workState.setSetpointMasterVal( 0 );
  #else
  if ( ab_isWorking ) arr_procData[cui8_indexWorkState].setSetpointMasterVal( 100 );
