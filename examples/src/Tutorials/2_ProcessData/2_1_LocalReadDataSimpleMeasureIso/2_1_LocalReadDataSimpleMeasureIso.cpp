/* *************************************************************************
                          2_1_LocalReadDataSimpleMeasureIso.cpp - tutorial for pure ISO address claim
                             -------------------
...
/* *********************************************************************** */
/** \example 2_1_LocalReadDataSimpleMeasureIso.cpp
 ...
 * <ol>
 * <li>This example ("2_1_LocalReadDataSimpleMeasureIso") creates some examplary 
 ...
 * An example for this request can be fount in 2_8_RemoteReadDataSimpleMeasureIso.
 ...
 *     conf_2_1_LocalReadDataSimpleMeasureIso from the directory where the spec file
 *     and the script are located<br>
 *     <i>#> update_makefile.sh conf_2_1_LocalReadDataSimpleMeasureIso</i>
 * <li><b>Only Linux:</b><ul>
 *     <li><i>#>cd 2_1_LocalReadDataSimpleMeasureIso</i> to go to the subdirectory 2_1_LocalReadDataSimpleMeasureIso
 *     <li><i>#> make</i><br>
 *     <li>GNU make will then use the fresh created Makefile to create the executable 2_1_LocalReadDataSimpleMeasureIso in this directory
 *     </ul>
 * <li><b>Other Development Environments:</b><ul>
 *     <li>import the file list in filelist-2_1_LocalReadDataSimpleMeasureIso.txt into the IDE of your choice
 *     <li>set <i>-DPRJ_USE_AUTOGEN_CONFIG=config_2_1_LocalReadDataSimpleMeasureIso</i> as global project parameter
 ...
 * \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__simulating__simulating .
 *
 * The adapted project specifications for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__rte
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__rte
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__sys
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__sys
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__sys
 ...
 * <ul>
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__simulating
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref PrjSpec2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__sys
 ...
 * See \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__simulating__simulating for needed files
 * ( filelist-2_1_LocalReadDataSimpleMeasureIso-doxygen_import.txt ),
 *  with \ref SrcList2_1_LocalReadDataSimpleMeasureIso__pc_linux__simulating__simulating containing the needed sources
 *  and with \ref HdrList2_1_LocalReadDataSimpleMeasureIso__pc_linux__simulating__simulating containing the needed headers.
 *
 * The resulting file lists for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__rte
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__rte
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_rte__sys
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_A1__sys
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_linux__msq_server_pcan__sys
 ...
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__simulating
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref FileLists2_1_LocalReadDataSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__sys
 ...
 * config_2_1_LocalReadDataSimpleMeasureIso ( see also at \ref PrjConfig2_1_LocalReadDataSimpleMeasureIso ).
 *                                                                         */
/* *************************************************************************/
