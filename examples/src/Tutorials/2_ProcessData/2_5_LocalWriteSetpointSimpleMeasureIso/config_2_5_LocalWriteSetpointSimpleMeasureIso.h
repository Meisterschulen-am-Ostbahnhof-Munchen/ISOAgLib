// File: config_2_5_LocalWriteSetpointSimpleMeasureIso.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_2_5_LocalWriteSetpointSimpleMeasureIso" 
//            Perform changes direct in the feature and project setup file conf_2_5_LocalWriteSetpointSimpleMeasureIso
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_2_5_LocalWriteSetpointSimpleMeasureIso" call,
