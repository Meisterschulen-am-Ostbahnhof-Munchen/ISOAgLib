/* *************************************************************************
                          2_5_LocalWriteSetpointSimpleMeasureIso.cpp - tutorial for pure ISO address claim
                             -------------------
...
/* *********************************************************************** */
/** \example 2_5_LocalWriteSetpointSimpleMeasureIso.cpp
 ...
 * <ol>
 * <li>This example ("2_5_LocalWriteSetpointSimpleMeasureIso") creates some examplary 
 * local process data. This process data is regualarly updated. The values are 
 * stored in an IsoAgLib::iProcDataLocalSimpleMeasure_c object. These values 
 * can be requested by remote processes over CAN-BUS communication. This stored data
 * does not support measurement programs. Remote devices can only perform one 
 * shot data requests ( start of a periodical send of data isn't supported -
 *    look at IsoAgLib::iProcDataLocal_c for this ). Furthermore this application 
 * allowes remote processes to define setpoints. An example for this request 
 * can be fount in 2_9_RemoteWriteSetpointStdIso. The following concepts are used 
 * to check for the device type of a setpoint's sender in order to
 ...
 *     conf_2_5_LocalWriteSetpointSimpleMeasureIso from the directory where the spec file
 *     and the script are located<br>
 *     <i>#> update_makefile.sh conf_2_5_LocalWriteSetpointSimpleMeasureIso</i>
 * <li><b>Only Linux:</b><ul>
 *     <li><i>#>cd 2_5_LocalWriteSetpointSimpleMeasureIso</i> to go to the subdirectory 2_5_LocalWriteSetpointSimpleMeasureIso
 *     <li><i>#> make</i><br>
 *     <li>GNU make will then use the fresh created Makefile to create the executable 2_5_LocalWriteSetpointSimpleMeasureIso in this directory
 *     </ul>
 * <li><b>Other Development Environments:</b><ul>
 *     <li>import the file list in filelist-2_5_LocalWriteSetpointSimpleMeasureIso.txt into the IDE of your choice
 *     <li>set <i>-DPRJ_USE_AUTOGEN_CONFIG=config_2_5_LocalWriteSetpointSimpleMeasureIso</i> as global project parameter
 ...
 * <ul>
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__rte
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__rte
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__sys
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__sys
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__sys
 ...
 * <ul>
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__simulating
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref PrjSpec2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__sys
 ...
 * See \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__simulating__simulating for needed files
 * ( filelist-2_5_LocalWriteSetpointSimpleMeasureIso-doxygen_import.txt ),
 *  with \ref SrcList2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__simulating__simulating containing the needed sources
 *  and with \ref HdrList2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__simulating__simulating containing the needed headers.
 *
 * The resulting file lists for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__rte
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__rte
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__rte
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__rte
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__simulating
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__simulating
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__simulating
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__simulating
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_no_card__sys
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_rte__sys
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_A1__sys
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_linux__msq_server_pcan__sys
 ...
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_no_card__simulating
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_sontheim__simulating
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__simulating
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__simulating
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_no_card__sys
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_sontheim__sys
 *		<li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_canlib__sys
 *    <li> \ref FileLists2_5_LocalWriteSetpointSimpleMeasureIso__pc_win32__can_server_sock_vector_xl_drv_lib__sys
 ...
 * config_2_5_LocalWriteSetpointSimpleMeasureIso ( see also at \ref PrjConfig2_5_LocalWriteSetpointSimpleMeasureIso ).
 *                                                                         */
/* *************************************************************************/
...
#include <IsoAgLib/comm/Part7_ProcessData/Local/SimpleMeasure/iprocdatalocalsimplemeasure_c.h>
...
bool MyProcDataHandler_c::processSetpointSet(IsoAgLib::EventSource_c ac_src, int32_t ai32_val, const IsoAgLib::iIsoName_c& ac_setpointSender, bool ab_change)
{
  ...
  uint16_t ui16_index = ac_src.makeIProcDataLocalSimpleMeasure() - arr_procData;
  switch ( ui16_index )
  {
