 ...
 * An example for this request can be found in 2_7_RemoteReadDataStdIso. 
 ...
 *     <li>import the file list in filelist__2_4_LocalWriteSetpointStdIso.txt into the IDE of your choice
 ...
 * ( filelist__2_4_LocalWriteSetpointStdIso.txt ),
