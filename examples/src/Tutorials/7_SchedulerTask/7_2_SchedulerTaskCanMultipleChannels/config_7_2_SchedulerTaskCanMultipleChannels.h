// File: config_7_2_SchedulerTaskCanMultipleChannels.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_7_2_SchedulerTaskCanMultipleChannels" 
//            Perform changes direct in the feature and project setup file conf_7_2_SchedulerTaskCanMultipleChannels
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_7_2_SchedulerTaskCanMultipleChannels" call,
