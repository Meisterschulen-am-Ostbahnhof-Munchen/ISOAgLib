...
public:// Public methods
  ...
  void init(const IsoAgLib::iIdentItem_c& acrc_ident, const IsoAgLib::iIsoName_c& acrc_rremoteECU SINGLETON_VEC_KEY_PARAMETER_DEF_WITH_COMMA);
  ...
  {
    return (IsoAgLib::iSystem_c::getTime() - i32_lastReceived);
  }
