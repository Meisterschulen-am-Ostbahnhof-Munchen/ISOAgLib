// File: config_6_0_VtThreadsEsxu.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_6_0_VtThreadsEsxu" 
//            Perform changes direct in the feature and project setup file conf_6_0_VtThreadsEsxu
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_6_0_VtThreadsEsxu" call,
...
#define SYSTEM_PM167
#endif // SYSTEM_PM167
#define PRJ_USE_AUTOGEN_CONFIG config_6_0_VtThreadsEsxu.h
#ifndef USE_MUTUAL_EXCLUSION
#define USE_MUTUAL_EXCLUSION
#endif // USE_MUTUAL_EXCLUSION
