// File: config_PcCompilation.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_PcCompilation" 
//            Perform changes direct in the feature and project setup file conf_PcCompilation
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_PcCompilation" call,
...
#define PRJ_USE_AUTOGEN_CONFIG config_PcCompilation.h
#ifndef DEBUG
#define DEBUG 
#endif // DEBUG
