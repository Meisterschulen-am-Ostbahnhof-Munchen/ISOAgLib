// File: config_PcCompilationSysNotEnHalMultipleInst.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_PcCompilationSysNotEnHalMultipleInst" 
//            Perform changes direct in the feature and project setup file conf_PcCompilationSysNotEnHalMultipleInst
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_PcCompilationSysNotEnHalMultipleInst" call,
