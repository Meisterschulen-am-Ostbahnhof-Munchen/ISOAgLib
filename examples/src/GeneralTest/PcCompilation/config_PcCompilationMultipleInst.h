// File: config_PcCompilationMultipleInst.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_PcCompilationMultipleInst" 
//            Perform changes direct in the feature and project setup file conf_PcCompilationMultipleInst
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_PcCompilationMultipleInst" call,
...
#define PRJ_USE_AUTOGEN_CONFIG config_PcCompilationMultipleInst.h


#define CAN_BUS_CNT 3 

#define CAN_INSTANCE_CNT 3 
...
#endif
#ifndef USE_TRACTOR_FACILITIES 
	#define USE_TRACTOR_FACILITIES 
#endif
