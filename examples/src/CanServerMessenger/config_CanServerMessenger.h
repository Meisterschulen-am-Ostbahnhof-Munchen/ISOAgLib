// File: config_CanServerMessenger.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_CanServerMessenger" 
//            Perform changes direct in the feature and project setup file conf_CanServerMessenger
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_CanServerMessenger" call,
...
#define PRJ_USE_AUTOGEN_CONFIG config_CanServerMessenger.h
