 ...
 * CanServerMessenger - based on IsoAgLib and "rte_can"
 ...
 *     <li>import the file list in filelist__CanServerMessenger.txt into the IDE of your choice
 ...
 * ( filelist__CanServerMessenger.txt ),
