// File: config_AutoDataCollector.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_AutoDataCollector" 
//            Perform changes direct in the feature and project setup file conf_AutoDataCollector
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_AutoDataCollector" call,
...
#ifndef USE_CAN_EEPROM_EDITOR
#define USE_CAN_EEPROM_EDITOR 
#endif // USE_CAN_EEPROM_EDITOR
