...
/**
  ...
  @see CounterI_c
  @see InputBase_c
  @short Hardware dependent object for hardware independent getting of inputs data.
...
public:
  ...
  */
  ...
  /**
    deliver reference to requested analog channel object to access this input;
  ...
  */
  ...
  /**
    deliver reference to requested digital channel object to access this input;
  ...
  */
  ...
  /**
    deliver reference to requested counter channel object to access this input;
...
private:
  ...
  /** private constructor which prevents direct instantiation in user application
    * NEVER define instance of Inputs_c within application
    */
  Inputs_c( void )
