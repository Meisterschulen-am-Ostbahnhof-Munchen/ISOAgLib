/*
  actor.h: include dependent on used target (defined in IsoAgLib/isoaglib_config.h) the suitable HAL specific header for actor output control
...
*/
/* ************************************************************ */
#ifndef _HAL_INDEPENDEND_ACTOR_H_
#define _HAL_INDEPENDEND_ACTOR_H_
