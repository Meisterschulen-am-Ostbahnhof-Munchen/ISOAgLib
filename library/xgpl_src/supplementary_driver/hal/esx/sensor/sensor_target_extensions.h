/*
  sensor_target_extensions.h: header for ESX specific extensions for
    the HAL for sensor input
...
/** \file hal/esx/sensor/sensor_target_extensions.h
...
#ifndef _HAL_ESX_SENSOR_TARGET_EXTENSIONS_H_
#define _HAL_ESX_SENSOR_TARGET_EXTENSIONS_H_
