...
/* ********** include headers ************ */
/* *************************************** */
#include <IsoAgLib/comm/Part7_ProcessData/Local/SimpleSetpointElements/impl/simplemanagesetpointlocal_c.h>
#include <IsoAgLib/comm/Part7_ProcessData/Local/impl/procdatalocalbase_c.h>
#include <IsoAgLib/comm/Part7_ProcessData/Local/StdMeasureElements/impl/managemeasureproglocal_c.h>
...
public:
  ...
  */
  ProcDataLocalSimpleSetpoint_c(const IsoAgLib::ElementDdi_s* ps_elementDDI = NULL, uint16_t aui16_element = 0xFFFF,
  ...
  */
  ...
  /** copy constructor */
  ProcDataLocalSimpleSetpoint_c( const ProcDataLocalSimpleSetpoint_c& acrc_src );

  /** assignment operator */
  const ProcDataLocalSimpleSetpoint_c& operator=( const ProcDataLocalSimpleSetpoint_c& acrc_src );
