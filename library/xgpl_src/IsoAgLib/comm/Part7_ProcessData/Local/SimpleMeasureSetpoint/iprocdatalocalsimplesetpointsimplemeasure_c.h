...
public:
  ...
  */
  ...
  void setProcessDataChangeHandler( ProcessDataChangeHandler_c *apc_processDataChangeHandler )
   { ProcDataLocalSimpleSetpointSimpleMeasure_c::setProcessDataChangeHandler( apc_processDataChangeHandler ); }
  ...
  */
  ...
  /**
    ...
    @return ISOName
  */
  const iIsoName_c& isoName() const {return ProcDataLocalSimpleSetpointSimpleMeasure_c::isoName().toConstIisoName_c();}
  ...
  */
  bool sendMasterMeasurementVal( const iIsoName_c& ac_targetISOName ) const
    { return ProcDataLocalSimpleSetpointSimpleMeasure_c::sendMasterMeasurementVal( ac_targetISOName );}
  ...
  */
  void setEepromAdr(uint16_t aui16_eepromAdr)
    {ProcDataLocalSimpleSetpointSimpleMeasure_c::setEepromAdr(aui16_eepromAdr);}
  #endif
  ...
  */
  void setMasterMeasurementVal(int32_t ai32_val)
    {ProcDataLocalSimpleSetpointSimpleMeasure_c::setMasterMeasurementVal(ai32_val);}
  ...
  */
  void incrMasterMeasurementVal(int32_t ai32_val)
    {ProcDataLocalSimpleSetpointSimpleMeasure_c::incrMasterMeasurementVal(ai32_val);}
  ...
  */
  void setMasterMeasurementVal(float af_val)
    {ProcDataLocalSimpleSetpointSimpleMeasure_c::setMasterMeasurementVal(af_val);}
  ...
  */
  void incrMasterMeasurementVal(float af_val)
    {ProcDataLocalSimpleSetpointSimpleMeasure_c::incrMasterMeasurementVal(af_val);}
#endif
  ...
  */
  void setSetpointMasterVal(int32_t ai32_val)
    { ProcDataLocalSimpleSetpointSimpleMeasure_c::setpoint().setSetpointMasterVal(ai32_val);}
  ...
  */
  void setSetpointMasterVal(float af_val)
    { ProcDataLocalSimpleSetpointSimpleMeasure_c::setpoint().setSetpointMasterVal(af_val);}
  #endif
