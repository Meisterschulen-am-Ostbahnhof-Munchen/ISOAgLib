...
#include <IsoAgLib/comm/Part7_ProcessData/Remote/SimpleSetpointElements/impl/simplemanagesetpointremote_c.h>
...
public:
  ...
  */
  const ProcDataRemoteSimpleSetpoint_c& operator=(const ProcDataRemoteSimpleSetpoint_c& acrc_src);

  /**
    copy constructor for IsoAgLibProcDataRemote
    @param acrc_src source instance
  */
   ProcDataRemoteSimpleSetpoint_c(const ProcDataRemoteSimpleSetpoint_c& acrc_src);
...
private: // Private attributes
  ...
  SimpleManageSetpointRemote_c mc_setpoint;

  /** object for managing jobs of remote measure programs */
  MeasureProgRemote_c mc_measure;
};
