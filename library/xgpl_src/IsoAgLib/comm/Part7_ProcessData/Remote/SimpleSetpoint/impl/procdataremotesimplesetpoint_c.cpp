...
*/
const ProcDataRemoteSimpleSetpoint_c& ProcDataRemoteSimpleSetpoint_c::operator=(const ProcDataRemoteSimpleSetpoint_c& arcc_src){
...
/**
  ...
  @param arcc_src source instance
*/
ProcDataRemoteSimpleSetpoint_c::ProcDataRemoteSimpleSetpoint_c(const ProcDataRemoteSimpleSetpoint_c& arcc_src)
