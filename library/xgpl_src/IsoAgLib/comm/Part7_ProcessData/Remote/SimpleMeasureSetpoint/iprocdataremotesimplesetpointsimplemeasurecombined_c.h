...
public:
  ...
  */
  ...
  :ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c( ps_elementDDI, aui16_element,
  ...
  */
  void init(const IsoAgLib::ElementDdi_s* ps_elementDDI,
            ...
            ProcessDataChangeHandler_c *apc_processDataChangeHandler = NULL,
            int ai_singletonVecKey = 0)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::init(ps_elementDDI, aui16_element,
                                                               ac_isoName, apc_commanderISOName,
                                                               apc_processDataChangeHandler, ai_singletonVecKey);
    }
  ...
  void setProcessDataChangeHandler( ProcessDataChangeHandler_c *apc_processDataChangeHandler )
   { ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setProcessDataChangeHandler( apc_processDataChangeHandler ); }
  ...
  */
  int32_t setpointMasterVal(bool ab_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setpointMasterVal(ab_sendRequest);}
  ...
  */
  void setSetpointMasterVal(int32_t ai32_val)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setSetpointMasterVal(ai32_val);}
  ...
  */
  float setpointMasterValFloat(bool ab_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setpointMasterValFloat(ab_sendRequest);}
  ...
  */
  void setSetpointMasterVal(float af_val)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setSetpointMasterVal(af_val);}
  #endif
  ...
  */
  int32_t masterMeasurementVal(bool ab_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::masterMeasurementVal(ab_sendRequest);}
  ...
  */
  float masterValFloat(bool ab_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::masterValFloat(ab_sendRequest);}
  #endif
  ...
  */
  void setCommanderISOName(const __IsoAgLib::IsoName_c* apc_externalOverridingIsoName)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setCommanderISOName(apc_externalOverridingIsoName);}
