...
public:
  ...
  */
  const ProcDataRemoteSimpleMeasure_c& operator=(const ProcDataRemoteSimpleMeasure_c& acrc_src);

  /**
    copy constructor for IsoAgLibProcDataRemote
    @param acrc_src source instance
  */
   ProcDataRemoteSimpleMeasure_c(const ProcDataRemoteSimpleMeasure_c& acrc_src);
