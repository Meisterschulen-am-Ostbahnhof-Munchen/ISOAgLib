/***************************************************************************
                          procdataremotesimplemeasure_c.cpp - managing of remote
                                                       process data object
                             -------------------
...
/* ********** include headers ************ */
/* *************************************** */
#include "procdataremotesimplemeasure_c.h"
...
*/
const ProcDataRemoteSimpleMeasure_c& ProcDataRemoteSimpleMeasure_c::operator=(const ProcDataRemoteSimpleMeasure_c& acrc_src){
...
/**
  ...
  @param acrc_src source instance
*/
ProcDataRemoteSimpleMeasure_c::ProcDataRemoteSimpleMeasure_c(const ProcDataRemoteSimpleMeasure_c& acrc_src)
...
ProcDataRemoteSimpleMeasure_c::~ProcDataRemoteSimpleMeasure_c(){
}
/**
...
void ProcDataRemoteSimpleMeasure_c::processSetpoint(){
  setpoint().processMsg();
}
/** process a measure prog message for remote process data */
void ProcDataRemoteSimpleMeasure_c::processProg(){
