...
public:
  /**
    ...
    */
  ProcDataRemote_c( const IsoAgLib::ElementDdi_s* ps_elementDDI = NULL, uint16_t aui16_element = 0xFFFF,
  ...
  */
  ...
  /**
    ...
    */
  const ProcDataRemote_c& operator=(const ProcDataRemote_c& acrc_src);

  /**
      copy constructor for IsoAgLibProcDataRemote
      @param acrc_src source instance
    */
   ProcDataRemote_c(const ProcDataRemote_c& acrc_src);
