...
// T1/T2 here are the same as in "multireceive_c.h"
static const int32_t msci32_timeOutT1=250;  // data -> data (was incorrectly 1000)
...
static const int32_t msci32_timeOutT4=550;  // cts(0)<->cts (was incorrectly 1100)
static const int32_t msci32_timeOutT5=250;  // dpo -> data (ETP only, naming "T5" done by Martin) (was incorrectly 1000)
