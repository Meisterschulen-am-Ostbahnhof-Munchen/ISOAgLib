...
{
public:
  StreamChunk_c (const ReceiveStreamIdentifier_c& ac_rsi, uint32_t aui32_msgSize, ecutime_t ai32_creationTime MULTITON_INST_PARAMETER_DEF_WITH_COMMA , bool b_skipCtsAwait);
