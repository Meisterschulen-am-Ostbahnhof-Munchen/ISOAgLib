...
void
ManageMeasureProg_c::timeEvent( ProcData_c& ac_processData, uint16_t& rui16_nextTimePeriod )
{
...
void
ManageMeasureProg_c::setVal( ProcData_c& ac_processData, int32_t ai32_val )
{
  mi32_value = ai32_val;
