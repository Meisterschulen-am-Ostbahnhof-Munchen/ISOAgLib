...
namespace IsoAgLib {
    ...
    ObjectType iVtObjectAuxiliaryFunction2_c::getObjectType() const { return objectType(); }

    ObjectType iVtObjectAuxiliaryFunction2_c::objectType() { return VT_OBJECT_TYPE_AUXILIARY_FUNCTION_2; }
} // IsoAgLib
