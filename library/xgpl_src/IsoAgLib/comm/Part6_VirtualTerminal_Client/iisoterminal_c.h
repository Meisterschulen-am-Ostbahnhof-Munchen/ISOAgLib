...
public:
  ...
  */
  iVtClientServerCommunication_c* initAndRegisterIsoObjectPool (iIdentItem_c& arc_wsMasterIdentItem, iIsoTerminalObjectPool_c& arc_pool, const char* apc_versionLabel)
