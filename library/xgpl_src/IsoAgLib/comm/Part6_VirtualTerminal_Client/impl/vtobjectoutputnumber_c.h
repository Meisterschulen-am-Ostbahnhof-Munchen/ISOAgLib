...
public:
  ...
  void init(const iVtObjectOutputNumber_s* vtObjectOutputNumberSROMs , int ai_multitonInst)
  { vtObject_c::init ((iVtObject_s*) vtObjectOutputNumberSROMs , ai_multitonInst);}
