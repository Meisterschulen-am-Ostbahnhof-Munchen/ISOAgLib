...
public:
  ...
  void init(const iVtObjectContainer_s* vtObjectContainer_sROM , int ai_multitonInst) { vtObject_c::init ((iVtObject_s*) vtObjectContainer_sROM MULTITON_INST_PARAMETER_USE_WITH_COMMA);}
