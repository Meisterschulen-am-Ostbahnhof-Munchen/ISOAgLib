...
namespace IsoAgLib {
  ...
  iVtObjectString_c::iVtObjectString_c(const iVtObjectOutputString_s* vtObjectOutputStringSROM , int ai_multitonInst)
  :vtObject_c((iVtObject_s*) vtObjectOutputStringSROM , ai_multitonInst)
  {}
