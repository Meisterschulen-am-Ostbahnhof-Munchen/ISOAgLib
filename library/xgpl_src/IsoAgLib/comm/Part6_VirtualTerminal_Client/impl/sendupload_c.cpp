...
SendUpload_c::set (uint8_t* apui8_buffer, uint32_t bufferSize)
{
  ...
  ppc_vtObjects = NULL;
    ...
    SendUpload_c::SendUpload_c(uint8_t byte1, uint8_t byte2, uint8_t byte3, uint8_t byte4, uint8_t byte5, uint8_t byte6,
                               uint8_t byte7, uint8_t byte8, IsoAgLib::iVtObject_c **rppc_vtObjects,
                               uint16_t aui16_numObjects)
    ...
    SendUpload_c::SendUpload_c(uint8_t *apui8_buffer, uint32_t bufferSize)
    ...
    void SendUpload_c::unsetStreamer() { mc_streamer = NULL; }

    SendUpload_c::SendUpload_c(const SendUpload_c &r_source)
