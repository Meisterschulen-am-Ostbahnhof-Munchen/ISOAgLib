...
vtObjectSoftKeyMask_c::vtObjectSoftKeyMask_c(
        const IsoAgLib::iVtObject_c::iVtObjectSoftKeyMask_s *vtObjectSoftKeyMaskSROM, int ai_multitonInst)
...
vtObjectSoftKeyMask_c::saveReceivedAttribute(uint8_t attrID, uint8_t* pui8_attributeValue)
{
  if (attrID == 1)
    ...
    void vtObjectSoftKeyMask_c::setBackgroundColour(uint8_t newValue, bool b_updateObject, bool b_enableReplaceOfCmd) {
