...
public:
  ...
  void init(const iVtObjectAlarmMask_s* vtObjectAlarmMaskSROM , int ai_multitonInst) { vtObject_c::init ((iVtObject_s*) vtObjectAlarmMaskSROM MULTITON_INST_PARAMETER_USE_WITH_COMMA); }
