...
public:
  ...
  uint32_t mui32_size;
  IsoAgLib::iVtObject_c* const * mpc_objectsToUpload; // @todo maybe this variable can be optimized away and mpc_iterObjects be directly used...

  /** pointers needed by MultiSendStreamer */
  IsoAgLib::iVtObject_c* const * mpc_iterObjects;
  IsoAgLib::iVtObject_c* const * mpc_iterObjectsStored;
