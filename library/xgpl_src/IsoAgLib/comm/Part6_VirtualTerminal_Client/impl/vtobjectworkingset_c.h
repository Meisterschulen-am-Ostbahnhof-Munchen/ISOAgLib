...
public:
  ...
  void init(const iVtObjectWorkingSet_s* vtObjectWorkingSetSROM , int ai_multitonInst) { vtObject_c::init ((iVtObject_s*) vtObjectWorkingSetSROM MULTITON_INST_PARAMETER_USE_WITH_COMMA); };
