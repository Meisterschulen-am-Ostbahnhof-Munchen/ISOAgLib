...
public:
  ...
  void init(const iVtObjectAuxiliaryInput_s* vtObjectAuxiliaryInputSROM , int ai_multitonInst) { vtObject_c::init ((iVtObject_s*) vtObjectAuxiliaryInputSROM MULTITON_INST_PARAMETER_USE_WITH_COMMA); }
