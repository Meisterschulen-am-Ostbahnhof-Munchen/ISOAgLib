...
namespace __IsoAgLib { // Begin Namespace __IsoAgLib
  ...
  {
    MACRO_MULTITON_GET_INSTANCE_BODY(TracPTOSetPoint_c, PRT_INSTANCE_CNT, instance);
  }

  bool TracPTOSetPoint_c::config_base ( IdentItem_c* apc_ident, IsoAgLib::IdentMode_t at_identMode, uint16_t aui16_suppressMask )
  {
...
/** dummy implementation
  ...
  */
bool TracPTOSetPoint_c::processMsgRequestPGN (uint32_t /*aui32_pgn*/, IsoItem_c* /*apc_isoItemSender*/, IsoItem_c* /*apc_isoItemReceiver*/, ecutime_t )
{
  return false;
}
