...
namespace __IsoAgLib { // Begin Namespace __IsoAglib
  ...
  { // if > 1 singleton instance is used, no static reference can be used
    MACRO_MULTITON_GET_INSTANCE_BODY(TracCert_c, PRT_INSTANCE_CNT, aui8_instance);
  }

  bool TracCert_c::config_base ( const IdentItem_c* apc_ident, IsoAgLib::IdentMode_t at_identMode, uint16_t aui16_suppressMask )
  {
