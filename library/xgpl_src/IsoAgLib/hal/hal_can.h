...
namespace HAL {
  ...
  */
//TODO Martin, this function does not seam to be needed? Called only once, return ignored...
//TODO Martin, im PC fall ist es ein #ifdef...
  ...
  */
   ...
   *  @param aui16_timeoutInterval timeout interval in ms.
  ...
  /**
    ...
    @param arc_mask filter mask of this MsgObj -> only for enhanced can hal
  ...
  */
  ...
  /**
    get the max send delay of a bus
    @param aui8_busN number of the BUS to check (default 0)
    @return BUS load of the last second [kbaud]
  */
  int32_t can_getMaxSendDelay( uint8_t aui8_busN = 0 );
#endif
  ...
  */
  ...
  /**
    ...
    @param refui32_msgId Id of the MsgObj to config
    @param refui8_msgtype unused TODO check if still needed!
    @param i32_rcvTime Last receive time for this message object.
    @return error code
