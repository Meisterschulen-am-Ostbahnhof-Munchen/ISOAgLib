/*
  system.h: definition of Hardware Abstraction Layer for central
    system functions for debug/simulation system on IMI
...
/** \file IsoAgLib/hal/imi/system/system.h
...
*/
/* ************************************************************ */
#ifndef _HAL_IMI_SYSTEM_H_
#define _HAL_IMI_SYSTEM_H_
...
/*@{*/
  ...
  */
  inline int16_t  getAdcUbat( void )
    {return (33 * __HAL::get_analogin_mean(ANA13));};
  /**
  ...
  */
  inline int16_t  getAdc_u85( void )
    {int16_t i16_temp = __HAL::get_analogin_mean(ANA9);
