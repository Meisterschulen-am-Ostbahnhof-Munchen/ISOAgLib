/*
  system.h: definition of Hardware Abstraction Layer for central
    system functions for debug/simulation system on PM167
 ...
 * The header <i>\<target\>/\<device\>/\<device\>.h</i> performs a name
   ...
   the needed activity. The implementation of the PM167 version
   can be used to derive the meaning of the specific function.
*/
/* ************************************************************ */
#ifndef _HAL_PM167_SYSTEM_H_
#define _HAL_PM167_SYSTEM_H_
