...
public:
  ...
  */
  void setIdentByte(uint8_t ab_val, uint8_t ab_pos) {
    mc_ident.setByte(ab_val, ab_pos);
  }
  ...
  */
  void setIdentWord(uint16_t aui16_val, uint8_t aui8_pos) {
    mc_ident.setWord(aui16_val, aui8_pos);
  }
  ...
  */
  void setDataUnion(const Flexible8ByteString_c* apc_data)
    { mui8_len = 8; mc_data = *apc_data; }
  ...
  */
  void setLen(uint8_t ab_val){mui8_len = (ab_val<9)?ab_val:uint8_t(8);}
  ...
  */
  void setUint16Data( uint8_t aui8_pos, uint16_t aui16_val)
    { mc_data.setUint16Data(aui8_pos, aui16_val);}
  ...
  */
  void setInt16Data( uint8_t aui8_pos, int16_t ai16_val)
    { mc_data.setInt16Data(aui8_pos, ai16_val);}
  ...
  */
  void setUint32Data( uint8_t aui8_pos, uint32_t aui32_val)
    { mc_data.setUint32Data(aui8_pos, aui32_val);}
  ...
  */
  void setInt32Data( uint8_t aui8_pos, int32_t ai32_val)
    { mc_data.setInt32Data(aui8_pos, ai32_val);}
  ...
  { mc_data.setFloatData(aui8_pos, af_val);}
