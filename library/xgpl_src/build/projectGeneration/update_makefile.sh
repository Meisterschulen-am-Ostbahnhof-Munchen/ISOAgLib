...
perform_everything()
{
  ...
  if [ $USE_TARGET_SYSTEM = "pc_linux" ] ; then
	...
	rm -f $GENERATE_FILES_ROOT_DIR/$FILELIST_LIBRARY_HDR $GENERATE_FILES_ROOT_DIR/$FILELIST_LIBRARY_PURE
	rm -f $GENERATE_FILES_ROOT_DIR/$FILELIST_APP_HDR $GENERATE_FILES_ROOT_DIR/$FILELIST_APP_PURE
	rm -f $GENERATE_FILES_ROOT_DIR/$FILELIST_COMBINED_HDR $GENERATE_FILES_ROOT_DIR/$FILELIST_COMBINED_PURE
	rm -f $GENERATE_FILES_ROOT_DIR/$FILELIST_UTEST_PURE $GENERATE_FILES_ROOT_DIR/$FILELIST_UTEST_MOCK_PURE
	rm -f $GENERATE_FILES_ROOT_DIR/$FILELIST_UTEST_MODSUT_PURE $GENERATE_FILES_ROOT_DIR/$FILELIST_UTEST_RUNNER_PURE
	rm -f $GENERATE_FILES_ROOT_DIR/$DIRECTORYLIST_UTEST_PURE
