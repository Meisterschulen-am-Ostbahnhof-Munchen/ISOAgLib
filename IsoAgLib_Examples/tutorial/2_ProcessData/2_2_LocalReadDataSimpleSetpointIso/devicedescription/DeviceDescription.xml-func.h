...
{
	{0x0042, 0, true, IsoAgLib::GeneralCommand_c::exactValue},
...
{
	{0x0001, 0, true, IsoAgLib::GeneralCommand_c::exactValue},
	{0x0002, 0, true, IsoAgLib::GeneralCommand_c::exactValue},
	// termination entry
	{0xFFFF, 0xFFFF, false, IsoAgLib::GeneralCommand_c::noValue}
};
#endif
