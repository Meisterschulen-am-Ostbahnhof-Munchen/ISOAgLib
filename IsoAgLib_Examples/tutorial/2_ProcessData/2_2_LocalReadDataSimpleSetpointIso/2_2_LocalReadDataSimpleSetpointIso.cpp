 ...
 *		<li> \ref PrjSpec2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_xl__simulating
 *		<li> \ref PrjSpec2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_canlib__sys
 *		<li> \ref PrjSpec2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_xl__sys
 ...
 *		<li> \ref FileLists2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_xl__simulating
 *		<li> \ref FileLists2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_canlib__sys
 *		<li> \ref FileLists2_2_LocalReadDataSimpleSetpointIso__pc_win32__vector_xl__sys
...
{ // init CAN channel with 250kBaud at channel 0 ( count starts with 0 )
  ...
  IsoAgLib::iProcDataLocalSimpleSetpoint_c c_myOnoff(0, myGtp, 0x1, 0x0, 0xFF, 2, myGtp, &myGtp, false);
  // local process data for "working width" [mm] of primaer Bodenbearbeitung (LIS=0, GETY=2, WERT=3, INST=1)
  IsoAgLib::iProcDataLocalSimpleSetpoint_c c_myWorkWidth( 0, myGtp, 0x3, 0x1, 0xFF, 2, myGtp, &myGtp, false);
  // local process data for "application rate" [kg/ha] of primaer Bodenbearbeitung (LIS=0, GETY=2, WERT=5, INST=0)
  IsoAgLib::iProcDataLocalSimpleSetpoint_c c_myApplicationRate( 0, myGtp, 0x5, 0x0, 0xFF, 2, myGtp, &myGtp, false);
