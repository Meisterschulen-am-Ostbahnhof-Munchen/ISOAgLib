/* *************************************************************************
                          2_6_LocalWriteSetpointSimpleSetpointIso.cc - tutorial for pure ISO address claim
                             -------------------
...
/* *********************************************************************** */
/** \example 2_6_LocalWriteSetpointSimpleSetpointIso.cc
 ...
 *	<li>Use IsoAgLib::iProcDataLocalSimpleSetpoint_c::init to define process data properties independend from instantiation ( needed especially for arrays of process data )
 ...
 *		<li> \ref PrjSpec2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_xl__simulating
 *		<li> \ref PrjSpec2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_canlib__sys
 *		<li> \ref PrjSpec2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_xl__sys
 ...
 *		<li> \ref FileLists2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_xl__simulating
 *		<li> \ref FileLists2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_canlib__sys
 *		<li> \ref FileLists2_6_LocalWriteSetpointSimpleSetpointIso__pc_win32__vector_xl__sys
 ...
 * config_2_6_LocalWriteSetpointSimpleSetpointIso ( see also at \ref PrjConfig2_6_LocalWriteSetpointSimpleSetpointIso__esx__sys__sys ).
 *                                                                         */
/* *************************************************************************/
...
{ // init CAN channel with 250kBaud at channel 0 ( count starts with 0 )
  ...
  // WERT == 5 -> device specific material flow information (mostly 5/0 -> distributed/harvested amount per area )
  IsoAgLib::iProcDataLocalSimpleSetpoint_c c_applicationRate(0, myGtp, 0x5, 0x0, 0xFF, 2, myGtp, &myGtp, false);
	#endif
