/* *************************************************************************
                          1_5_WriteFlexibleDin.cc - tutorial for pure ISO address claim
                             -------------------
...
/* *********************************************************************** */
/** \example 1_5_WriteFlexibleDin.cc
 ...
 *     conf_1_5_WriteFlexibleDin from the directory where the spec file
 *     and the script are located<br>
 *     <i>#> update_makefile.sh conf_1_5_WriteFlexibleDin</i>
 * <li><b>Only Linux:</b><ul>
 *     <li><i>#>cd 1_5_WriteFlexibleDin</i> to go to the subdirectory 1_5_WriteFlexibleDin
 *     <li><i>#> make</i><br>
 *     <li>GNU make will then use the fresh created Makefile to create the executable 1_5_WriteFlexibleDin in this directory
 *     </ul>
 * <li><b>Other Development Environments:</b><ul>
 *     <li>import the file list in filelist-1_5_WriteFlexibleDin.txt into the IDE of your choice
 *     <li>set <i>-DPRJ_USE_AUTOGEN_CONFIG=config_1_5_WriteFlexibleDin</i> as global project parameter
 ...
 * \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__simulating__simulating .
 *
 * The adopted project specifications for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__rte__rte
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__rte__simulating
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__rte__sys
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__simulating__rte
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__simulating__simulating
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pc_linux__simulating__sys
 *	</ul>
 ...
 * <ul>
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__esx__sys__sys
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__imi__sys__sys
 *		<li> \ref PrjSpec1_5_WriteFlexibleDin__pm167__sys__sys
 *	</ul>
 * </ul>
 *
 * <H1>Resulting Project File List</H1>
 * See \ref FileLists1_5_WriteFlexibleDin__pc_linux__simulating__simulating for needed files
 * ( filelist-1_5_WriteFlexibleDin-doxygen_import.txt ),
 *  with \ref SrcList1_5_WriteFlexibleDin__pc_linux__simulating__simulating containing the needed sources
 *  and with \ref HdrList1_5_WriteFlexibleDin__pc_linux__simulating__simulating containing the needed headers.
 *
 * The resulting file lists for different setups:
 * <ul>
 * <li>Configuration Setups for Linux on PC:
 * <ul>
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__rte__rte
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__rte__simulating
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__rte__sys
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__simulating__rte
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__simulating__simulating
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pc_linux__simulating__sys
 *	</ul>
 * <li>Configuration Setups for Win32 on PC:
 * <ul>
 ...
 * <li>Configuration Setupts for some embedded targets:
 * <ul>
 *		<li> \ref FileLists1_5_WriteFlexibleDin__esx__sys__sys
 *		<li> \ref FileLists1_5_WriteFlexibleDin__imi__sys__sys
 *		<li> \ref FileLists1_5_WriteFlexibleDin__pm167__sys__sys
 *	</ul>
 * </ul>
 *
 ...
 * config_1_5_WriteFlexibleDin ( see also at \ref PrjConfig1_5_WriteFlexibleDin__esx__sys__sys ).
 *                                                                         */
/* *************************************************************************/
...
/** the define PRJ_USE_AUTOGEN_CONFIG is used by xgpl_src/Application_Config/isoaglib_config.h
	...
	*/
	...
	#define PRJ_USE_AUTOGEN_CONFIG config_1_5_WriteFlexibleDin.h
#endif
