/* *************************************************************************
                          0_3_LookupIso.cc - tutorial for lookup for remote ISO ECU
                             -------------------
 ...
 *	<li>Alternativaly use IsoAgLib::iISOMonitor_c::existIsoMemberGtp() to restrict
 ...
 * config_0_3_LookupIso ( see also at \ref PrjConfig0_3_LookupIso__esx__sys__sys ).
 *                                                                         */
/* *************************************************************************/
...
{ // simply call startImi
  ...
  IsoAgLib::iGetyPos_c myGtp( 2, 0 );
	...
	IsoAgLib::iGetyPos_c lookupGtp( 5, 0 );
