/***************************************************************************
                 .h -   stores, updates and delivers all moving
 ...
 ***************************************************************************/
#ifndef PROPRIETARY_C_H
#define PROPRIETARY_C_H
...
#include "IsoAgLib/comm/ProprietaryCan/iproprietarymessagehandler_c.h"
...
//  class ProprietaryCanClient_c;
  ...
  class ProprietaryCanClient_c : public ProprietaryMessageClient_c
  {
  public:// Public methods

    ProprietaryCanClient_c() {i32_lastReceived = 0;};
    ...
    int32_t lastTimeSinceUpdate() const
    {
      return (System_c::getTime() - i32_lastReceived);
    }
  ...
  private: // Private methods
    ...
    const IsoAgLib::iIdentItem_c* pc_identItem;
  };
}
#endif
