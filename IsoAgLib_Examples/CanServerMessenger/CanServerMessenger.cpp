...
int main( int argc, char *argv[] )
{
  ...
  // Initialize CAN-Bus
  getIcanInstance().init (params.i_channel, 250); // CAN-Bus (with defaulting 250 kbit)

  iCANPkg_c pkg;

  pkg.setIdent(params.i_id, (params.b_ext ? __IsoAgLib::Ident_c::ExtendedIdent : __IsoAgLib::Ident_c::StandardIdent));
