...
/* Adapted by OSB-AG due to disabled exceptions
 */
...
#include <exception>
#include <assert.h> //added by OSB-AG due to disabled exceptions
...
public:
	...
	*/ 
#if 0 // disabled because of problems with compiler xscale_le-g++
...
#else // replaced by OSB-AG due to disabled exceptions
    assert(rawPtr);
#endif
		return rawPtr;
	}
