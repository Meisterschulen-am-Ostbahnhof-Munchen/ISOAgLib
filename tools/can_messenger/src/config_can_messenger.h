...
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_can_messenger" 
//            Perform changes direct in the feature and project setup file conf_can_messenger
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_can_messenger" call,
