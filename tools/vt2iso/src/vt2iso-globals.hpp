...
extern signed int stringoptionstoi (const char *text_options);
extern signed int inputnumberoptionstoi (const char *text_options);
extern signed int numberoptionstoi (const char *text_options);
...
extern signed int inputobjectoptiontoi (const char *text_inputobjectoptions);
extern signed int buttonoptiontoi (const char *text_buttonoptions);
