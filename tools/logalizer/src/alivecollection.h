...
public:
  ...
  std::vector< msgType_e > const &response(
      Category_e ae_category,
      uint8_t ui8_address) const;
...
inline AliveCollection_c::Category_e AliveCollection_c::nextCategory(
    Category_e ae_category)
{
...
inline AliveCollection_c::Category_s::Category_s() :
  svec_alives(),
  svec_response(),
  name(""),
  alivePeriod(0)
...
inline std::vector< uint64_t > &AliveCollection_c::alives(
    Category_e ae_category,
    uint8_t ui8_address)
{
...
inline std::vector< uint64_t > const &AliveCollection_c::alives(
    Category_e ae_category,
    uint8_t ui8_address) const
{
  return marr_categories[ae_category].svec_alives[ui8_address];
...
inline std::vector< msgType_e > &AliveCollection_c::response(
    Category_e ae_category,
    uint8_t ui8_address)
{
...
inline std::vector< msgType_e > const &AliveCollection_c::response(
    Category_e ae_category,
    uint8_t ui8_address) const
{
  return marr_categories[ae_category].svec_response[ui8_address];
...
inline int32_t AliveCollection_c::alivePeriod(Category_e ae_category) const
{
  return marr_categories[ae_category].alivePeriod;
}

inline void AliveCollection_c::setAlivePeriod(Category_e ae_category, int32_t ai32_alivePeriod)
{
  marr_categories[ae_category].alivePeriod = ai32_alivePeriod;
}

inline char const *AliveCollection_c::name(Category_e ae_category) const
{
  return marr_categories[ae_category].name;
}

inline void AliveCollection_c::setName(Category_e ae_category, char const *pch_name)
{
  marr_categories[ae_category].name = pch_name;
}

#endif//ndef ALIVECOLLECTION_H
