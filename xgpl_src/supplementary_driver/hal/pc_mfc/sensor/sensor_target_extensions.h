...
#ifndef _PC_MFC_SENSOR_TARGET_EXTENSIONS_H_
#define _PC_MFC_SENSOR_TARGET_EXTENSIONS_H_
...
/**
  ...
  @return according channel number for __HAL call
*/
inline uint8_t getDiginAdcCheckNr(uint8_t rb_channel)
  {return (rb_channel < 2)?(87 - rb_channel):(33 - rb_channel);};
#endif
