...
#ifndef _HAL_PC_MFC_RS232_H_
#define _HAL_PC_MFC_RS232_H_

// Multiple RS232 ports, so must use the channel parameter in the function calls!
#define USE_RS232_CHANNEL

#include <IsoAgLib/hal/pc_mfc/config.h>
#include <IsoAgLib/hal/pc_mfc/typedef.h>
#include <IsoAgLib/hal/pc_mfc/errcodes.h>
...
namespace HAL
{
  ...
  */
  inline int16_t init_rs232(uint16_t wBaudrate,uint8_t bMode,uint8_t bStoppbits,bool bitSoftwarehandshake, uint8_t rui8_channel)
    {return __HAL::init_rs232(wBaudrate,bMode,bStoppbits,bitSoftwarehandshake, rui8_channel) ;};
  /** close the RS232 interface. */
  inline int16_t close_rs232(uint8_t rui8_channel)
    {return __HAL::close_rs232(rui8_channel);};
  /**
  ...
  */
  inline int16_t setRs232Baudrate(uint16_t wBaudrate, uint8_t rui8_channel)
    {return __HAL::setRs232Baudrate(wBaudrate, rui8_channel) ;};
  /**
  ...
  */
  inline int16_t getRs232RxBufCount(uint8_t rui8_channel)
    {return __HAL::getRs232RxBufCount(rui8_channel);};
  /**
  ...
  */
  inline int16_t getRs232TxBufCount(uint8_t rui8_channel)
    {return __HAL::getRs232TxBufCount(rui8_channel);};
  /**
  ...
  */
  inline int16_t configRs232RxObj(uint16_t wBuffersize,void (*pFunction)(uint8_t *bByte), uint8_t rui8_channel)
    {return __HAL::configRs232RxObj(wBuffersize,pFunction, rui8_channel) ;};
  /**
  ...
  */
  inline int16_t configRs232TxObj(uint16_t wBuffersize,void (*funktionAfterTransmit)(uint8_t *bByte),
    ...
    {return __HAL::configRs232TxObj(wBuffersize,funktionAfterTransmit,funktionBeforTransmit, rui8_channel);};
  /**
  ...
  */
  inline int16_t getRs232Error(uint8_t *Errorcode, uint8_t rui8_channel)
    {return __HAL::getRs232Error(Errorcode, rui8_channel);};
  ...
  */
  inline int16_t getRs232Char(uint8_t *pbRead, uint8_t rui8_channel)
    {return __HAL::getRs232Char(pbRead, rui8_channel);};
  /**
  ...
  */
  inline int16_t getRs232String(uint8_t *pbRead,uint8_t bLastChar, uint8_t rui8_channel)
    {return __HAL::getRs232String(pbRead,bLastChar, rui8_channel);};
  ...
  */
  inline int16_t put_rs232Char(uint8_t bByte, uint8_t rui8_channel)
    {return __HAL::put_rs232Char(bByte, rui8_channel);};
  /**
  ...
  */
  inline int16_t put_rs232NChar(const uint8_t *bpWrite,uint16_t wNumber, uint8_t rui8_channel)
    {return __HAL::put_rs232NChar(bpWrite,wNumber, rui8_channel);};
  /**
  ...
  */
  inline int16_t put_rs232String(const uint8_t *pbString, uint8_t rui8_channel)
    {return __HAL::put_rs232String(pbString, rui8_channel);};
  ...
  */
  inline void clearRs232RxBuffer(uint8_t rui8_channel)
    {__HAL::clearRs232RxBuffer(rui8_channel);};
  /**
    clear send puffer
  */
  inline void clearRs232TxBuffer(uint8_t rui8_channel)
    {__HAL::clearRs232TxBuffer(rui8_channel);};
  /*@}*/
}
#endif
