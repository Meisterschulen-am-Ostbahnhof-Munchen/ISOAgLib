...
//#endif
   ...
   */
   ...
   /**
      for BIOS-Test only!
   */
   inline int16_t can_configMsgobjChgid(uint8_t BusNr, uint8_t ObjNr, uint32_t Ident, uint8_t IdType)
   {
      return __HAL::can_configMsgobjChgid(BusNr, ObjNr, Ident, IdType);
   };
   ...
   */
   ...
   /**
      ...
      for BIOS-Test only!
   */
   inline int16_t can_useMsgobjSend(uint8_t rui8_busNr, uint8_t rui8_msgobjNr, canBuffer_pt *CanMsg_pp)
   {
      return __HAL::can_useMsgobjSend(rui8_busNr, rui8_msgobjNr, CanMsg_pp);
   };
#else
   ...
   */
   ...
   /**
      for BIOS-Test only!
   */
   inline int16_t can_useMsgobjGet(uint8_t rui8_busNr, uint8_t rui8_msgobjNr, canBuffer_pt *CanMsg_pp)
   {
      return __HAL::can_useMsgobjGet(rui8_busNr, rui8_msgobjNr, CanMsg_pp);
   };
#else
