  ...
  for (;;) {
    ...
    switch (msqCommandBuf.i16_command) {
      ...
      case COMMAND_REGISTER:
      {
        ...
        s_tmpClient.i32_clientID = 0;
        s_tmpClient.i64_systemStart4Timeofday = 0;
        s_tmpClient.i64_deltaStartTimes = 0;
        memset(s_tmpClient.ui16_globalMask, 0, sizeof(s_tmpClient.ui16_globalMask));
        memset(s_tmpClient.ui32_globalMask, 0, sizeof(s_tmpClient.ui32_globalMask));
        memset(s_tmpClient.ui32_lastMask, 0, sizeof(s_tmpClient.ui32_lastMask));
        s_tmpClient.i32_pipeHandle = 0;
