...
/*@{*/
  ...
  */
  ...
  {
    return ( __HAL::Can_GlobalInit(aui8_busNr, ab_baudrate, ab_maskStd,
  ...
  */
  inline int16_t can_configGlobalMask ( uint8_t aui8_busNr, uint16_t ab_maskStd,
                           uint32_t aui32_maskExt, uint32_t aui32_maskLastmsg )
  {
    return ( __HAL::Can_GlobalMask(aui8_busNr, ab_maskStd,
                                     aui32_maskExt, aui32_maskLastmsg) );
  };
