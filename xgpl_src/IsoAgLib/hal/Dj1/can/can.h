...
/*@{*/
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanGlobalWarn(rui8_busNr) == __HAL::BIOS_TRUE) ? true : false );
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanBusOff(rui8_busNr) == __HAL::BIOS_TRUE) ? true : false );
  };
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanBlocked(rui8_busNr) == __HAL::BIOS_TRUE) ? true : false );
  };
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanBitCount ( rui8_busNr ) + 500) / 1000 );
  };
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanBit1Err(rui8_busNr) == __HAL::BIOS_TRUE) ? true : false );
  };
...
/*@{*/
  ...
  */
  ...
  {
    return ( __HAL::DjBios_CanObjTxTimeStamp ( rui8_busNr, rui8_msgobjNr ) );
  };
  ...
  */
  ...
  {
    return ( (__HAL::DjBios_CanObjTxBuffFull(rui8_busNr, rui8_msgobjNr) == __HAL::BIOS_CAN_Q_FULL)? true : false );
  };
  ...
  */
  ...
  {
    return ( __HAL::Can_ObjBufferCount(rui8_busNr, rui8_msgobjNr) );
  };
  ...
  */
  ...
  {
    return ( __HAL::Can_ObjBufferSpace(rui8_busNr, rui8_msgobjNr) );
  };
...
/*@{*/
  ...
  */
  inline int16_t can_configGlobalInit  ( uint8_t rui8_busNr, uint16_t rb_baudrate,
              uint16_t rb_maskStd, uint32_t rui32_maskExt, uint32_t rui32_maskLastmsg )
  {
    return ( __HAL::Can_GlobalInit(rui8_busNr, rb_baudrate, rb_maskStd,
  ...
  */
  inline int16_t can_configGlobalMask ( uint8_t rui8_busNr, uint16_t rb_maskStd,
                           uint32_t rui32_maskExt, uint32_t rui32_maskLastmsg )
  {
    return ( __HAL::Can_GlobalMask(rui8_busNr, rb_maskStd,
                                     rui32_maskExt, rui32_maskLastmsg) );
  };
  ...
  */
  ...
  {
    return ( __HAL::Can_Close(rui8_busNr) );
  };
  ...
  */
  ...
  {
    return ( __HAL::DjBios_CanWaitUntilRx(rui16_timeoutInterval)?true:false );
  };
...
/*@{*/
  ...
  /**
    ...
    @return HAL_NO_ERR == no error;
            ...
            HAL_RANGE_ERR == wrong BUS or MsgObj number
  */
  inline int16_t can_configMsgobjInit(uint8_t rui8_busNr, uint8_t rui8_msgobjNr,
                            __IsoAgLib::Ident_c& rrefc_ident, uint8_t rb_rxtx)
  {
    return ( __HAL:: Can_ObjectInit(rui8_busNr, rui8_msgobjNr, rrefc_ident, rb_rxtx) );
  };
  ...
  */
  inline int16_t can_configMsgobjChgid ( uint8_t rui8_busNr, uint8_t rui8_msgobjNr,
                                           __IsoAgLib::Ident_c& rrefc_ident )
  {
    return ( __HAL:: Can_ObjectChange(rui8_busNr, rui8_msgobjNr, rrefc_ident) );
  };
...
//    return __HAL::can_configMsgobjSendpause(rui8_busNr, rui8_msgobjNr, rui16_minSend);
  ...
  */
  ...
  {
    return ( __HAL::Can_ObjClose(rui8_busNr, rui8_msgobjNr) );
  };
...
/*@{*/
  ...
  */
  inline int32_t can_useMsgobjReceivedIdent ( uint8_t rui8_busNr, uint8_t rui8_msgobjNr,
                                                          int32_t &reflIdent )
  {
    return ( __HAL::Can_ReadObjRxIdent(rui8_busNr, rui8_msgobjNr, reflIdent) );
  };
  ...
  */
  ...
  {
    (void)__HAL::DjBios_CanObjPop ( rui8_busNr, rui8_msgobjNr );
  };
  ...
  */
  ...
  {
    return __HAL::Can_PurgeObj ( rui8_busNr, rui8_msgobjNr );
  };
