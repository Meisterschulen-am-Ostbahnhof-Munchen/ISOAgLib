...
#define HAL_CAN_LAST_MSG_OBJ_NR ( HAL_CAN_MSGOBJ_OFFSET + 14 )
#define HAL_CAN_MIN_SEND_OBJ HAL_CAN_MSGOBJ_OFFSET
#define HAL_CAN_MAX_SEND_OBJ ( HAL_CAN_MSGOBJ_OFFSET + 13 )
// the send msg objects take the lowest possible msg ob numbers
// ==> take 2 as min msg obj nr
#define HAL_CAN_MIN_REC_OBJ ( HAL_CAN_MSGOBJ_OFFSET + 1 )
#define HAL_CAN_MAX_REC_OBJ ( HAL_CAN_MSGOBJ_OFFSET + 14 )
