...
class ProcDataLocalBase_c : public ProcDataBase_c
{
  ...
  */
  ProcDataLocalBase_c(uint8_t rui8_lis = 0xFF,
      ...
      ) : ProcDataBase_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum, rui8_pri, rc_ownerGtp, rpc_gtp,
                            rpc_processDataChangeHandler, ri_singletonVecKey )
    {init(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum, rui8_pri, rc_ownerGtp, rpc_gtp, rb_cumulativeValue
      #ifdef USE_EEPROM_IO
      , rui16_eepromAdr
      #endif // USE_EEPROM_IO
