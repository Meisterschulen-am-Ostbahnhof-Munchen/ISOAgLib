...
public:
  ...
  */
  iProcDataLocalSimpleMeasure_c(uint8_t rui8_lis = 0xFF,
  ...
  ) : ProcDataLocalSimpleMeasure_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
  ...
  */
  ...
  /**
    ...
    @return GETY_POS
  */
  iGetyPos_c gtp() const {return ProcDataLocalSimpleMeasure_c::gtp();};
  /**
  ...
  */
  const int32_t& masterVal()const{return ProcDataLocalSimpleMeasure_c::masterVal();};
  /**
  ...
  */
  void setMasterVal(int32_t ri32_val)
    {ProcDataLocalSimpleMeasure_c::setMasterVal(ri32_val);};
  /**
    set the masterVal from main application independent from any measure progs
    @param ri32_val new measure value
  */
  void setMasterVal(int16_t ri16_val)
    {ProcDataLocalSimpleMeasure_c::setMasterVal((int32_t)ri16_val);};
  /**
    set the masterVal from main application independent from any measure progs
    @param ri32_val new measure value
  */
  void setMasterVal(uint8_t rb_val)
    {ProcDataLocalSimpleMeasure_c::setMasterVal((int32_t)rb_val);};
  /**
  ...
  */
  void incrMasterVal(int32_t ri32_val)
    {ProcDataLocalSimpleMeasure_c::incrMasterVal(ri32_val);};
  ...
  */
  void setMasterVal(float rf_val)
    {ProcDataLocalSimpleMeasure_c::setMasterVal(rf_val);};
  /**
    increment the value -> update the local and the measuring programs values
    @param rf_val size of increment of master value
  */
  void incrMasterVal(float rf_val)
    {ProcDataLocalSimpleMeasure_c::incrMasterVal(rf_val);};
#endif
  ...
  */
  uint16_t internalUnit()const{return ProcDataLocalSimpleMeasure_c::internalUnit();};
  /**
  ...
  */
  void setInternalUnit(uint16_t rui16_internalUnit)
      {ProcDataLocalSimpleMeasure_c::setInternalUnit(rui16_internalUnit);};

  /**
    deliver the send conversion, which is used to send measuring values
    @return conversion value
  */
  const int32_t& sendConversion()const{return ProcDataLocalSimpleMeasure_c::sendConversion();};
  /**
  ...
  */
  void setSendConversion(int32_t ri32_sendConversion)
      {ProcDataLocalSimpleMeasure_c::setSendConversion(ri32_sendConversion);};
  /**
  ...
  */
  int32_t setpointMasterVal(bool rb_percented = false) const
    { return ProcDataLocalSimpleMeasure_c::setpointConst().setpointMasterVal(rb_percented);};
  /**
    retrieve percent setpoint value
    @return percent value (set to initial 100)
  */
  uint8_t setpointPercentVal()const
    { return ProcDataLocalSimpleMeasure_c::setpointConst().setpointPercentVal();};
  ...
  */
  void setSetpointPercentVal(uint8_t rb_percent)
    { ProcDataLocalSimpleMeasure_c::setpoint().setSetpointPercentVal(rb_percent);};
    #ifdef USE_FLOAT_DATA_TYPE
  /**
    retreive simple master setpoint
    @param rb_percented optional calculate with percent value (default false)
  ...
  */
  float setpointMasterValFloat(bool rb_percented = false) const
    { return ProcDataLocalSimpleMeasure_c::setpointConst().setpointMasterValFloat(rb_percented);};
    #endif
  #else
  /**
    retreive simple master setpoint
