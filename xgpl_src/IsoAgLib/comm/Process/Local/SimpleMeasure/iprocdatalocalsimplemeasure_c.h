...
public:
  ...
  */
  ...
  /**
    ...
    @return ISOName
  */
  const iISOName_c& isoName() const {return static_cast<const iISOName_c&>(ProcDataLocalSimpleMeasure_c::isoName());}
  ...
  */
  bool sendMasterMeasurementVal( const iISOName_c& rc_targetISOName, Proc_c::progType_t ren_progType = Proc_c::Target ) const
    { return ProcDataLocalSimpleMeasure_c::sendMasterMeasurementVal( rc_targetISOName, ren_progType );};
