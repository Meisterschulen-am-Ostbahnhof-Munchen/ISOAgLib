...
public:
  ...
  */
  iProcDataLocalSimpleSetpointSimpleMeasure_c(uint8_t rui8_lis = 0xFF,
  ...
  ) : ProcDataLocalSimpleSetpointSimpleMeasure_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
  ...
  */
  ...
  /**
    ...
    @return GETY
  */
  uint8_t gety() const{return ProcDataLocalSimpleSetpointSimpleMeasure_c::gety();};
  /**
    ...
    @return GETY_POS
  */
  iGetyPos_c gtp() const {return ProcDataLocalSimpleSetpointSimpleMeasure_c::gtp();};
  /**
  ...
  */
  ...
  /**
    ...
    @return POS
  */
  uint8_t pos() const{return ProcDataLocalSimpleSetpointSimpleMeasure_c::pos();};
  ...
  */
  bool sendVal( iGetyPos_c rc_targetGtp, Proc_c::progType_t ren_progType = Proc_c::Target ) const
    { return ProcDataLocalSimpleSetpointSimpleMeasure_c::sendVal( rc_targetGtp, ren_progType );};
  /**
  ...
  */
  uint16_t internalUnit()const{return ProcDataLocalSimpleSetpointSimpleMeasure_c::internalUnit();};
  /**
  ...
  */
  void setInternalUnit(uint16_t rui16_internalUnit)
      {ProcDataLocalSimpleSetpointSimpleMeasure_c::setInternalUnit(rui16_internalUnit);};

  /**
    deliver the send conversion, which is used to send measuring values
    @return conversion value
  */
  const int32_t& sendConversion()const{return ProcDataLocalSimpleSetpointSimpleMeasure_c::sendConversion();};
  /**
  ...
  */
  void setSendConversion(int32_t ri32_sendConversion)
      {ProcDataLocalSimpleSetpointSimpleMeasure_c::setSendConversion(ri32_sendConversion);};
  /**
  ...
  */
  void setSetpointMasterVal(int32_t ri32_val)
    { return ProcDataLocalSimpleSetpointSimpleMeasure_c::setpoint().setSetpointMasterVal(ri32_val);};
  #ifdef USE_FLOAT_DATA_TYPE
  /**
  ...
  */
  void setSetpointMasterVal(float rf_val)
    { return ProcDataLocalSimpleSetpointSimpleMeasure_c::setpoint().setSetpointMasterVal(rf_val);};
  #endif
