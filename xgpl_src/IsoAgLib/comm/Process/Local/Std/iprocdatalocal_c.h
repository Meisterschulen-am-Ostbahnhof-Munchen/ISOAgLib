...
public:
  ...
  */
  ...
  /**
    ...
    @return DEV_KEY
  */
  const iDevKey_c& devKey() const {return static_cast<const iDevKey_c&>(ProcDataLocal_c::devKey());};
  /**
  ...
  */
  bool sendVal( const iDevKey_c& rc_targetDevKey, Proc_c::progType_t ren_progType = Proc_c::Target ) const
    { return ProcDataLocal_c::sendVal( rc_targetDevKey, ren_progType );};
  /**
  ...
  */
  ...
  {
    return setpointConst().sendSetpointMod( rc_targetDevKey, ren_progType,
  ...
  */
  const int32_t& masterVal()const{return ProcDataLocal_c::masterVal();};
  /**
  ...
  */
  void setMasterVal(int32_t ri32_val)
    {ProcDataLocal_c::setMasterVal(ri32_val);};
  /**
    set the masterVal from main application independent from any measure progs
    @param ri32_val new measure value
  */
  void setMasterVal(int16_t ri16_val)
    {ProcDataLocal_c::setMasterVal((int32_t)ri16_val);};
  /**
    set the masterVal from main application independent from any measure progs
    @param ri32_val new measure value
  */
  void setMasterVal(uint8_t rb_val)
    {ProcDataLocal_c::setMasterVal((int32_t)rb_val);};
  /**
  ...
  */
  void incrMasterVal(int32_t ri32_val)
    {ProcDataLocal_c::incrMasterVal(ri32_val);};
  ...
  */
  void setMasterVal(float rf_val)
    {ProcDataLocal_c::setMasterVal(rf_val);};
  /**
    increment the value -> update the local and the measuring programs values
  ...
  */
  bool existProg(uint8_t rui8_pri, const iDevKey_c& rc_devKey)
      {return ProcDataLocal_c::existProg(rui8_pri, rc_devKey);};
  ...
  */
  iMeasureProgLocal_c& prog(uint8_t rui8_pri, const iDevKey_c& rc_devKey, bool rb_doCreate)
    { return static_cast<iMeasureProgLocal_c&>(ProcDataLocal_c::prog(rui8_pri, rc_devKey, rb_doCreate));};
