/***************************************************************************
                          lbsProcdataLocalSimplesetpoint.cc  -  description
                             -------------------
...
*/
ProcDataLocalSimpleSetpoint_c::ProcDataLocalSimpleSetpoint_c(uint8_t rui8_lis, GetyPos_c rc_gtp, uint8_t rui8_wert,
...
/**
  ...
  @param ri_singletonVecKey optional key for selection of IsoAgLib instance (default 0)
*/
void ProcDataLocalSimpleSetpoint_c::init(uint8_t rui8_lis, GetyPos_c rc_gtp, uint8_t rui8_wert,
      uint8_t rui8_inst, uint8_t rui8_zaehlnum, uint8_t rui8_pri, GetyPos_c rc_ownerGtp,
      GetyPos_c *rpc_gtp, bool rb_cumulativeValue
      #ifdef USE_EEPROM_IO
      , uint16_t rui16_eepromAdr
...
*/
void ProcDataLocalSimpleSetpoint_c::setMasterVal(int32_t ri32_val){
...
*/
void ProcDataLocalSimpleSetpoint_c::incrMasterVal(int32_t ri32_val){
...
*/
void ProcDataLocalSimpleSetpoint_c::setMasterVal(float rf_val){
...
/**
  ...
  @param ri32_val size of increment of master value
*/
void ProcDataLocalSimpleSetpoint_c::incrMasterVal(float rf_val){
