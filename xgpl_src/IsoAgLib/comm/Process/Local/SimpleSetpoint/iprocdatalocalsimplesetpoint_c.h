...
public:
  ...
  */
  int32_t setpointMasterVal(bool rb_percented = false) const
    { return ProcDataLocalSimpleSetpoint_c::setpointConst().setpointMasterVal(rb_percented);};
  /**
    retrieve percent setpoint value
    @return percent value (set to initial 100)
  */
  uint8_t setpointPercentVal()const
    { return ProcDataLocalSimpleSetpoint_c::setpointConst().setpointPercentVal();};
  /**
    set the setpoint percent value
    @param rb_percent new percent setpoint value
  */
  void setSetpointPercentVal(uint8_t rb_percent)
    { ProcDataLocalSimpleSetpoint_c::setpoint().setSetpointPercentVal(rb_percent);};
    #ifdef USE_FLOAT_DATA_TYPE
  /**
    retreive simple master setpoint
    @param rb_percented optional calculate with percent value (default false)
  ...
  */
  float setpointMasterValFloat(bool rb_percented = false) const
    { return ProcDataLocalSimpleSetpoint_c::setpointConst().setpointMasterValFloat(rb_percented);};
    #endif
  #else
  /**
    retreive simple master setpoint
  ...
  */
  void setSetpointMasterVal(int32_t ri32_val)
    { return ProcDataLocalSimpleSetpoint_c::setpoint().setSetpointMasterVal(ri32_val);};
  #ifdef USE_FLOAT_DATA_TYPE
  /**
  ...
  */
  void setSetpointMasterVal(float rf_val)
    { return ProcDataLocalSimpleSetpoint_c::setpoint().setSetpointMasterVal(rf_val);};
  #endif
