...
public:
  ...
  */
  ProcDataBase_c(GetyPos_c rc_gtp = GetyPos_c(0, 0xF),
  ...
  : ProcIdent_c(rc_gtp, rui16_DDI, rui16_element, rui8_pri, rc_ownerGtp, rpc_gtp, ri_singletonVecKey)
    {init(rc_gtp, rui16_DDI, rui16_element, rui8_pri, rc_ownerGtp, rpc_gtp,
  ...
  /**
    ...
    @param ri_singletonVecKey optional key for selection of IsoAgLib instance (default 0)
    */
  void init( GetyPos_c rc_gtp = GetyPos_c(0, 0xF),
                        uint16_t rui16_DDI = 0, uint16_t rui16_element = 0xFF,
                        uint8_t rui8_pri = 2, GetyPos_c rc_ownerGtp = GetyPos_c(0xF, 0xF), GetyPos_c *rpc_gtp = NULL,
                        IsoAgLib::ProcessDataChangeHandler_c *rpc_processDataChangeHandler = NULL,
                        int ri_singletonVecKey = 0);
...
public:
  ...
  */
  ProcDataBase_c( uint8_t rui8_lis = 0, GetyPos_c rc_gtp = GetyPos_c(0, 0xF),
                        ...
                        ::IsoAgLib::ProcessDataChangeHandler_c *rpc_processDataChangeHandler = NULL,
                        int ri_singletonVecKey = 0)
  : ProcIdent_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum, rui8_pri, rc_ownerGtp, rpc_gtp, ri_singletonVecKey)
    {init(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum, rui8_pri, rc_ownerGtp, rpc_gtp,
                                         rpc_processDataChangeHandler, ri_singletonVecKey);};
  /**
    initialise this ProcDataBase_c instance to a well defined initial state
    @param rpc_lbs optional pointer to central Scheduler_c instance
...
#endif  // #if not defined ISO_TASK_CONTROLLER
