...
private: // Private attributes
  ...
  class _data {
    public:
      _data( const DevKey_c& rrefc_ownerDevKey, const DevKey_c& rrefc_devKey, uint16_t rui8_zaehlnum, uint16_t rui8_wert, uint16_t rui8_inst, uint16_t rui8_lis, uint16_t rui8_pri);
      _data( const _data& rrefc_src);
    /**
