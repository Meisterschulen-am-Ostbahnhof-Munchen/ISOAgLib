...
*/
ProcDataRemoteSimpleMeasure_c::ProcDataRemoteSimpleMeasure_c(uint8_t rui8_lis, GetyPos_c rc_gtp, uint8_t rui8_wert,
...
/**
  ...
  @param ri_singletonVecKey optional key for selection of IsoAgLib instance (default 0)
*/
void ProcDataRemoteSimpleMeasure_c::init(uint8_t rui8_lis, GetyPos_c rc_gtp, uint8_t rui8_wert,
      uint8_t rui8_inst, uint8_t rui8_zaehlnum, uint8_t rui8_pri, GetyPos_c rc_ownerGtp,
      GetyPos_c* rpc_commanderGtp,
      IsoAgLib::ProcessDataChangeHandler_c *rpc_processDataChangeHandler,
      int ri_singletonVecKey)
