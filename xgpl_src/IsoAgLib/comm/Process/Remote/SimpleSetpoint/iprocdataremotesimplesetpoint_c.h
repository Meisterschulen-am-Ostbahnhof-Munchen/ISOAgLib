...
public:
  ...
  */
  ...
  /**
    ...
    @return GETY
  */
  uint8_t gety() const{return ProcDataRemoteSimpleSetpoint_c::gety();};
  /**
  ...
  */
  ...
  /**
    ...
    @return POS
  */
  uint8_t pos() const{return ProcDataRemoteSimpleSetpoint_c::pos();};
  ...
  */
  uint8_t setpointPercentVal(bool rb_sendRequest = false)
    {return ProcDataRemoteSimpleSetpoint_c::setpointPercentVal(rb_sendRequest);};
  /**
  ...
  */
  void setSetpointPercentVal(uint8_t rb_val)
    {ProcDataRemoteSimpleSetpoint_c::setSetpointPercentVal(rb_val);};
  /**
  ...
  */
  int32_t masterVal(bool rb_sendRequest = false)
    {return ProcDataRemoteSimpleSetpoint_c::masterVal(rb_sendRequest);};
  /**
  ...
  */
  iGetyPos_c commanderGtp()const{return ProcDataRemoteSimpleSetpoint_c::commanderGtp();};
  /**
  ...
  */
  void setCommanderGtp(iGetyPos_c* rpc_gtp){ProcDataRemoteSimpleSetpoint_c::setCommanderGtp(rpc_gtp);};
  ...
  */
  uint16_t internalUnit()const{return ProcDataRemoteSimpleSetpoint_c::internalUnit();};
  /**
