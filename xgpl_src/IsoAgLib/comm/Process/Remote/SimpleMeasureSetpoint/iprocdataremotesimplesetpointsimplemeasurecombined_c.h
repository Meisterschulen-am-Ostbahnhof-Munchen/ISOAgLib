...
public:
  ...
  */
  iProcDataRemoteSimpleSetpointSimpleMeasureCombined_c(uint8_t rui8_lis = 0xFF, iGetyPos_c rc_gtp = 0,
  ...
  : ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
  ...
  */
  void init(uint8_t rui8_lis = 0xFF, iGetyPos_c rc_gtp = 0,
      ...
      iGetyPos_c* rpc_commanderGtp = NULL,
      ProcessDataChangeHandler_c *rpc_processDataChangeHandler = NULL, int ri_singletonVecKey = 0)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::init(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
      rui8_pri, rc_ownerGtp, rpc_commanderGtp, rpc_processDataChangeHandler, ri_singletonVecKey);};
  ...
  */
  uint8_t setpointPercentVal(bool rb_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setpointPercentVal(rb_sendRequest);};
  /**
  ...
  */
  void setSetpointPercentVal(uint8_t rb_val)
    {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setSetpointPercentVal(rb_val);};
  /**
  ...
  */
  const int32_t& sendConversion()const
    {return ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::sendConversion();};
  /**
  ...
  */
  void setSendConversion(int32_t ri32_sendConversion)
      {ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c::setSendConversion(ri32_sendConversion);};
