...
class ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c : public ProcDataRemoteBase_c  {
  ...
  */
  ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c(uint8_t rui8_lis = 0xFF, GetyPos_c rc_gtp = 0,
  ...
  */
  const ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c&
    operator=(const ProcDataRemoteSimpleSetpointSimpleMeasureCombined_c& rrefc_src);
