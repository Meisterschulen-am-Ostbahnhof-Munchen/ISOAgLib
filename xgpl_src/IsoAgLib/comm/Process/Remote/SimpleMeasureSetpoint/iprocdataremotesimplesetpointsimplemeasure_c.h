...
public:
  ...
  */
  iProcDataRemoteSimpleSetpointSimpleMeasure_c(uint8_t rui8_lis = 0xFF, iGetyPos_c rc_gtp = 0,
  ...
  : ProcDataRemoteSimpleSetpointSimpleMeasure_c(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
  ...
  */
  void init(uint8_t rui8_lis = 0xFF, iGetyPos_c rc_gtp = 0,
      ...
      iGetyPos_c* rpc_commanderGtp = NULL,
      ProcessDataChangeHandler_c *rpc_processDataChangeHandler = NULL, int ri_singletonVecKey = 0)
    {ProcDataRemoteSimpleSetpointSimpleMeasure_c::init(rui8_lis, rc_gtp, rui8_wert, rui8_inst, rui8_zaehlnum,
      rui8_pri, rc_ownerGtp, rpc_commanderGtp, rpc_processDataChangeHandler, ri_singletonVecKey);};
  ...
  */
  ...
  /**
    ...
    @return GETY
  */
  uint8_t gety() const{return ProcDataRemoteSimpleSetpointSimpleMeasure_c::gety();};
  /**
  ...
  */
  ...
  /**
    ...
    @return POS
  */
  uint8_t pos() const{return ProcDataRemoteSimpleSetpointSimpleMeasure_c::pos();};
  ...
  */
  int32_t masterVal(bool rb_sendRequest = false)
    {return ProcDataRemoteSimpleSetpointSimpleMeasure_c::masterVal(rb_sendRequest);};
  /**
  ...
  */
  iGetyPos_c commanderGtp()const{return ProcDataRemoteSimpleSetpointSimpleMeasure_c::commanderGtp();};
  /**
  ...
  */
  void setCommanderGtp(iGetyPos_c* rpc_gtp){ProcDataRemoteSimpleSetpointSimpleMeasure_c::setCommanderGtp(rpc_gtp);};
  ...
  */
  uint16_t internalUnit()const{return ProcDataRemoteSimpleSetpointSimpleMeasure_c::internalUnit();};
  /**
  ...
  */
  void setInternalUnit(uint16_t rui16_internalUnit)
      {ProcDataRemoteSimpleSetpointSimpleMeasure_c::setInternalUnit(rui16_internalUnit);};

  /**
    deliver the send conversion, which is used to send measuring values
    @return conversion value
  */
  const int32_t& sendConversion()const{return ProcDataRemoteSimpleSetpointSimpleMeasure_c::sendConversion();};
  /**
  ...
  */
  void setSendConversion(int32_t ri32_sendConversion)
      {ProcDataRemoteSimpleSetpointSimpleMeasure_c::setSendConversion(ri32_sendConversion);};
