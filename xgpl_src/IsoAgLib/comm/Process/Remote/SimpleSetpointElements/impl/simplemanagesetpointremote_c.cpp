...
void SimpleManageSetpointRemote_c::processSetpoint()
{
  ...
  if (!c_pkg.c_generalCommand.checkIsRequest())
  {
    ...
    if ( processDataConst().getProcessDataChangeHandler() != NULL )
      processDataConst().getProcessDataChangeHandler()->processSetpointResponse( pprocessData(), processData().pkgDataLong(), static_cast<const IsoAgLib::iISOName_c&>(c_pkg.memberSend().isoName()) );
  }
}
...
int32_t SimpleManageSetpointRemote_c::setpointMasterVal(bool rb_sendRequest)
{
  ...
  if (rb_sendRequest) {
    ...
    c_base.sendValISOName(c_base.pri(), c_base.commanderISOName(), int32_t(0));
  }
...
void SimpleManageSetpointRemote_c::setSetpointMasterVal(int32_t ri32_val, bool rb_onlyStoreOnResponse)
{
  ...
  c_base.sendValISOName(c_base.pri(), c_base.commanderISOName(), ri32_val);
...
void SimpleManageSetpointRemote_c::setSetpointMasterVal(float rf_val, bool rb_onlyStoreOnResponse)
{
  ...
  c_base.sendValISOName(c_base.pri(), c_base.commanderISOName(), rf_val);
