/***************************************************************************
                          simplemanagesetpointremote_c.h  - managing of remote
                                                   process data object
                             -------------------
 ...
 ***************************************************************************/
#ifndef SIMPLE_MANAGE_SETPOINT_REMOTE_H
#define SIMPLE_MANAGE_SETPOINT_REMOTE_H
...
/**
  ...
  */
class SimpleManageSetpointRemote_c : public ProcessElementBase_c
{
  friend class ProcDataRemoteSimpleSetpointSimpleMeasure_c;
  friend class ProcDataRemoteSimpleSetpoint_c;
 public:
  /**
