...
public:
  ...
  */
...
#ifdef USE_PROC_REMOTE_STD
  iProcDataRemote_c* addDDI2ExistingProcData(uint16_t aui16_DDI, uint16_t aui_deviceElement, const iIsoName_c& ac_isoName, GeneralCommand_c::ValueGroup_t& ren_valueGroup, bool rb_isSetpoint)
...
#ifdef USE_PROC_REMOTE_SIMPLE_MEASURE
  iProcDataRemoteSimpleMeasure_c* addDDI2ExistingProcData(uint16_t aui16_DDI, uint16_t aui_deviceElement, const iIsoName_c& ac_isoName, GeneralCommand_c::ValueGroup_t& ren_valueGroup, bool rb_isSetpoint)
...
#ifdef USE_PROC_REMOTE_SIMPLE_SETPOINT
  iProcDataRemoteSimpleSetpoint_c* addDDI2ExistingProcData(uint16_t aui16_DDI, uint16_t aui_deviceElement, const iIsoName_c& ac_isoName, GeneralCommand_c::ValueGroup_t& ren_valueGroup, bool rb_isSetpoint)
...
#ifdef USE_PROC_REMOTE_SIMPLE_MEASURE_SETPOINT
  iProcDataRemoteSimpleMeasureSetpoint_c* addDDI2ExistingProcData(uint16_t aui16_DDI, uint16_t aui_deviceElement, const iIsoName_c& ac_isoName, GeneralCommand_c::ValueGroup_t& ren_valueGroup, bool rb_isSetpoint)
...
#ifdef USE_PROC_REMOTE_SIMPLE_MEASURE_SETPOINT_COMBINED
  iProcDataRemoteSimpleMeasureSetpointCombined_c* addDDI2ExistingProcData(uint16_t aui16_DDI, uint16_t aui_deviceElement, const iIsoName_c& ac_isoName, GeneralCommand_c::ValueGroup_t& ren_valueGroup, bool rb_isSetpoint)
  ...
  bool addProprietaryDDI2Group(uint16_t aui16_DDI, uint16_t aui_deviceElement, bool b_isSetpoint, GeneralCommand_c::ValueGroup_t ddiType, const iIsoName_c& ac_isoName)
