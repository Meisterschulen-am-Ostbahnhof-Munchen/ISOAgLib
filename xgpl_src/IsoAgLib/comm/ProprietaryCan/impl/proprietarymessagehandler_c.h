...
//    bool timeEvent( void );
    ...
    */
    bool registerProprietaryMessageClient (ProprietaryMessageClient_c* rpc_proprietaryclient);

    /** deregister ProprietaryMessageClient */
    bool deregisterProprietaryMessageClient (ProprietaryMessageClient_c* rpc_proprietaryclient);
     ...
     */
    void reactOnMonitorListAdd( const __IsoAgLib::ISOName_c& refc_isoName, const __IsoAgLib::ISOItem_c* rpc_newItem );
