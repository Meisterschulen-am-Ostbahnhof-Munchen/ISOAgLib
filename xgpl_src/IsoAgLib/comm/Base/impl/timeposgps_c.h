...
public:
  ...
  /** Retrieve the last update time of the specified information type*/
  int32_t lastedTimeSinceUpdateGpsCourse() const;
  /** Retrieve the time of last update */
  int32_t lastUpdateTimeGpsCourse() const;
  ...
  void setSpeedOverGroundCmSec( uint16_t rui16_newVal ) { ui16_speedOverGroundCmSec = rui16_newVal;};
  /** deliver GPS Heading [1x10E-4rad] */
  void setGpsHeadingRad10Minus4( uint16_t rui16_newVal ) { ui16_headingRad10Minus4 = rui16_newVal; };
  void setGpsCourseOverGroundRad10Minus4( uint16_t rui16_newVal ) { ui16_courseOverGroundRad10Minus4 = rui16_newVal; };
  ...
  */
  ...
  /** deliver GPS speed as [cm/s] */
  uint16_t getSpeedOverGroundCmSec( void ) const { return ui16_speedOverGroundCmSec;};
  ...
  /** deliver GPS COG [1x10E-4rad] */
  uint16_t getGpsCourseOverGroundRad10Minus4( void ) const { return ui16_courseOverGroundRad10Minus4; };
  /** deliver number of received satellites */
...
private:
  ...
  int32_t i32_lastIsoDirectionSimple;
