// ----------------------------------------------------------------------
// File    : vtobjectauxiliaryinput_c.h
...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectAuxiliaryInput_s* vtObjectAuxiliaryInputSROM SINGLETON_VEC_KEY_PARAMETER_DEF_WITH_COMMA)
  {vtObject_c::init((iVtObject_s *)vtObjectAuxiliaryInputSROM SINGLETON_VEC_KEY_PARAMETER_VAR_WITH_COMMA);}
