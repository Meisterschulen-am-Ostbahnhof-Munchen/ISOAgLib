...
//  +X2C Class 172 : vtObjectLineAttributes_c
//!  Stereotype: Klasse
...
public:
  ...
  void setLineColour(uint8_t newValue, bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectLineAttributes_a(), lineColour) : 0, sizeof(iVtObjectLineAttributes_s), 1, newValue, __IsoAgLib::getIsoTerminalInstance().getUserClippedColor (newValue, this, IsoAgLib::LineColour));
  }
  
  void setLineWidth(uint8_t newValue, bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectLineAttributes_a(), lineWidth) : 0, sizeof(iVtObjectLineAttributes_s), 2, newValue, newValue);
  }

  void setLineArt(uint8_t newValue, bool b_updateObject=false) {
    saveValue16SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectLineAttributes_a(), lineArt) : 0, sizeof(iVtObjectLineAttributes_s), 3, newValue);
  }
