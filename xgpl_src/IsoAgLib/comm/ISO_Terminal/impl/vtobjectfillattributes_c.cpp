...
{// ~X2C
  ...
  __IsoAgLib::getIsoTerminalInstance().sendCommandChangeFillAttributes (this, newFillType, __IsoAgLib::getIsoTerminalInstance().getUserClippedColor (newFillColour, this, IsoAgLib::FillColour), newFillPattern, b_enableReplaceOfCmd);
}// -X2C
