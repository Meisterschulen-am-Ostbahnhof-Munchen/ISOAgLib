...
void
vtObjectObjectPointer_c::setValue(IsoAgLib::iVtObject_c* rpc_newObject, bool b_updateObject)
{ // ~X2C
  ...
  if (rpc_newObject != NULL) __IsoAgLib::getIsoTerminalInstance().sendCommandChangeNumericValue (this, rpc_newObject->getID() & 0xFF, (rpc_newObject->getID() >> 8) & 0xFF, 0x00, 0x00);
                        else __IsoAgLib::getIsoTerminalInstance().sendCommandChangeNumericValue (this, 0xFF, 0xFF, 0x00, 0x00);
} // -X2C
