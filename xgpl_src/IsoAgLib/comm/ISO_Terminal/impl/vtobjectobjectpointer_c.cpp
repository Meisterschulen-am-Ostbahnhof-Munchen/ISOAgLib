...
{ // ~X2C
  ...
  if (rpc_newObject != NULL) __IsoAgLib::getIsoTerminalInstance().sendCommandChangeNumericValue (this, rpc_newObject->getID() & 0xFF, (rpc_newObject->getID() >> 8) & 0xFF, 0x00, 0x00, b_enableReplaceOfCmd);
                        else __IsoAgLib::getIsoTerminalInstance().sendCommandChangeNumericValue (this, 0xFF, 0xFF, 0x00, 0x00, b_enableReplaceOfCmd);
} // -X2C
