...
public:
  ...
  void changeActiveMask(IsoAgLib::iVtObjectMask_c* rpc_vtObjectMask, bool b_updateObject= false);

  
  void changeBackgroundColour(uint8_t newColour, bool b_updateObject= false);
