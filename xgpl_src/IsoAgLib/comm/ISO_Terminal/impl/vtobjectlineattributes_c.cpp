...
#define MACRO_vtObjectTypeS iVtObjectLineAttributes_s
    ...
    if (sourceOffset == 0) { // dump out constant sized stuff
      ...
      destMemory [3] = __IsoAgLib::getIsoTerminalInstance().getUserClippedColor (vtObjectLineAttributes_a->lineColour);
...
void
vtObjectLineAttributes_c::setLineAttributes(uint8_t newLineColour, uint8_t newLineWidth, uint16_t newLineArt, bool b_updateObject) {
  if (b_updateObject) {
    saveValue8 (MACRO_getStructOffset(get_vtObjectLineAttributes_a(), lineColour), sizeof(iVtObjectLineAttributes_s), newLineColour);
  ...
  __IsoAgLib::getIsoTerminalInstance().sendCommandChangeLineAttributes (this, newLineColour, newLineWidth, newLineArt);
}
