...
#define MACRO_vtObjectTypeS iVtObjectInputNumber_s
    ...
    if (sourceOffset == 0) { // dump out constant sized stuff
      ...
      destMemory [7] = __IsoAgLib::getIsoTerminalInstance().getUserClippedColor (vtObjectInputNumber_a->backgroundColour, this, IsoAgLib::BackgroundColour);
      ...
      destMemory [36] = vtObjectInputNumber_a->enabled;
...
// //////////////////////////////// +X2C Operation 118 : vtObjectInputNumber_c
vtObjectInputNumber_c::vtObjectInputNumber_c()
{ // ~X2C
} // -X2C

// //////////////////////////////// +X2C Operation 196 : size
uint32_t
vtObjectInputNumber_c::fitTerminal()
{ // ~X2C
  MACRO_localVars;
...
void
vtObjectInputNumber_c::setSize(uint16_t newWidth, uint16_t newHeight, bool b_updateObject)
{
  if (b_updateObject) {
