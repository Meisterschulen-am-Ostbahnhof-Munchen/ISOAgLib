...
//  +X2C Class 179 : vtObjectObjectPointer_c
//!  Stereotype: Klasse
...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectObjectPointer_s* vtObjectObjectPointerSROM) { vtObject_c::init ((iVtObject_s*) vtObjectObjectPointerSROM); };
  ...
  void setValue(IsoAgLib::iVtObject_c* rpc_newObject, bool b_updateObject= false);
