...
#define MACRO_vtObjectTypeS iVtObjectContainer_s
    ...
    MACRO_streamEventMacro(10+vtObjectContainer_a->numberOfObjectsToFollow*6);
    return curBytes;
} // -X2C
...
void
vtObjectContainer_c::hideShow(uint8_t b_hideOrShow, bool b_updateObject)
{ // ~X2C
...
void
vtObjectContainer_c::setSize(uint16_t newWidth, uint16_t newHeight, bool b_updateObject)
{
  if (b_updateObject) {
