...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectFontAttributes_s* vtObjectFontAttributesSROM) { vtObject_c::init ((iVtObject_s*) vtObjectFontAttributesSROM); };
  ...
  void setFontColour(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectFontAttributes_a(), fontColour) : 0, sizeof(iVtObjectFontAttributes_s), 1, newValue);
  }
  
  void setFontSize(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectFontAttributes_a(), fontSize) : 0, sizeof(iVtObjectFontAttributes_s), 2, newValue);
  }
  
  void setFontType(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectFontAttributes_a(), fontType) : 0, sizeof(iVtObjectFontAttributes_s), 3, newValue);
  }

  void setFontStyle(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectFontAttributes_a(), fontStyle) : 0, sizeof(iVtObjectFontAttributes_s), 4, newValue);
  }
