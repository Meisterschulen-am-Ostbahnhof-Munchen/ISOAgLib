...
void
vtObjectWorkingSet_c::changeActiveMask(IsoAgLib::iVtObjectMask_c* rpc_vtObjectMask, bool b_updateObject)
{ // ~X2C
...
void
vtObjectWorkingSet_c::changeBackgroundColour(uint8_t newValue, bool b_updateObject)
{ // ~X2C
  ...
  __IsoAgLib::getIsoTerminalInstance().sendCommandChangeBackgroundColour (this, newValue);
} // -X2C

bool
vtObjectWorkingSet_c::moveChildLocation(IsoAgLib::iVtObject_c* rpc_childObject, int8_t dx, int8_t dy, bool b_updateObject)
{
  MACRO_localVars;
