...
//!  Stereotype: Klasse
class vtObjectInputList_c : public IsoAgLib::iVtObjectInput_c
{
...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectInputList_s* vtObjectInputListSROM) { vtObject_c::init ((iVtObject_s*) vtObjectInputListSROM); };
  ...
  //! @param rui8_index:
  //! @param rpc_object:
  void setItem(uint8_t rui8_index, IsoAgLib::iVtObject_c* rpc_object);

  // //////////////////////////////////
  // All special Attribute-Set methods
  void setWidth(uint16_t newValue, bool b_updateObject=false) {
    saveValue16SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectInputList_a(), width) : 0, sizeof(iVtObjectInputList_s), 1, newValue);
  }
  
  void setHeight(uint16_t newValue, bool b_updateObject=false) {
    saveValue16SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectInputList_a(), height) : 0, sizeof(iVtObjectInputList_s), 2, newValue);
  }

  void setVariableReference(IsoAgLib::iVtObject_c* newValue, bool b_updateObject=false) {
    saveValuePSetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectInputList_a(), variableReference) : 0, sizeof(iVtObjectInputList_s), 3, newValue);
  }
