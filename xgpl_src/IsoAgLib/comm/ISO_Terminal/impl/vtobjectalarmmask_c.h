...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectAlarmMask_s* vtObjectAlarmMaskSROM) { vtObject_c::init ((iVtObject_s*) vtObjectAlarmMaskSROM); };
  ...
  void setBackgroundColour(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectAlarmMask_a(), backgroundColour) : 0, sizeof(iVtObjectAlarmMask_s), 1, newValue, __IsoAgLib::getIsoTerminalInstance().getUserClippedColor (newValue, this, IsoAgLib::BackgroundColour));
  }
  
  void setSoftKeyMask(IsoAgLib::iVtObjectSoftKeyMask_c* newSoftKeyMask, bool b_updateObject= false);
  
  void setPriority(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectAlarmMask_a(), priority) : 0, sizeof(iVtObjectAlarmMask_s), 3, newValue, newValue);
  }
  
  void setAcousticSignal(uint8_t newValue,  bool b_updateObject=false) {
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectAlarmMask_a(), acousticSignal) : 0, sizeof(iVtObjectAlarmMask_s), 4, newValue, newValue);
  }
