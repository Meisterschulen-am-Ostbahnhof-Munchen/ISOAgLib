...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectInputBoolean_s* vtObjectInputBooleanSROM) { vtObject_c::init ((iVtObject_s*) vtObjectInputBooleanSROM); };
  ...
  // //////////////////////////////////
    ...
    saveValue8SetAttribute ((b_updateObject) ? MACRO_getStructOffset(get_vtObjectInputBoolean_a(), backgroundColour) : 0, sizeof(iVtObjectInputBoolean_s), 1, newValue);
	}
