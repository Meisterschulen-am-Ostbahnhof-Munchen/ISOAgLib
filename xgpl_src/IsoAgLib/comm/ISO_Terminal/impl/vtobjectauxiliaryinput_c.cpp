...
//! @param sourceOffset: 
int16_t
vtObjectAuxiliaryInput_c::stream(uint8_t* destMemory, uint16_t maxBytes, uint16_t sourceOffset)
{ // ~X2C
...
bool
vtObjectAuxiliaryInput_c::moveChildLocation(IsoAgLib::iVtObject_c* rpc_childObject, int8_t dx, int8_t dy, bool b_updateObject)
{
  MACRO_localVars;
  return genericChangeChildLocation (rpc_childObject, dx, dy, b_updateObject, vtObjectAuxiliaryInput_a->numberOfObjectsToFollow, (IsoAgLib::repeat_iVtObject_x_y_iVtObjectFontAttributes_row_col_s *) vtObjectAuxiliaryInput_a->objectsToFollow, MACRO_getStructOffset(get_vtObjectAuxiliaryInput_a(), objectsToFollow), sizeof(iVtObjectAuxiliaryInput_s));
}

bool
vtObjectAuxiliaryInput_c::setChildPosition(IsoAgLib::iVtObject_c* rpc_childObject, int16_t x, int16_t y, bool b_updateObject)
{
  MACRO_localVars;
  return genericChangeChildPosition (rpc_childObject, x, y, b_updateObject, vtObjectAuxiliaryInput_a->numberOfObjectsToFollow, (IsoAgLib::repeat_iVtObject_x_y_iVtObjectFontAttributes_row_col_s *) vtObjectAuxiliaryInput_a->objectsToFollow, MACRO_getStructOffset(get_vtObjectAuxiliaryInput_a(), objectsToFollow), sizeof(iVtObjectAuxiliaryInput_s));
}
