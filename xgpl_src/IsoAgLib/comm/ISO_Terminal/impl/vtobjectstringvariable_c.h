...
public:
  ...
  //! @param b_initPointer:
  void init(const iVtObjectStringVariable_s* vtObjectStringVariableSROM) { vtObject_c::init ((iVtObject_s*) vtObjectStringVariableSROM); };
  ...
  void setValueCopy(char* newValue, bool b_updateObject= false);

  //  Operation: setValueRef
  //! Parameter:
  //! @param newValue:
  //! @param b_updateObject:
  void setValueRef(char* newValue, bool b_updateObject= false);
