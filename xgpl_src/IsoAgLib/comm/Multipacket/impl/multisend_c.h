/***************************************************************************
                             multisend_c.h - transfer of multi message
                                                data
                             -------------------
...
*/
class MultiSend_c : public CANCustomer_c, public ElementBase_c, public SINGLETON(MultiSend_c)  {
private:
public:
...
private: // Private methods
  friend class SINGLETON(MultiSend_c);
