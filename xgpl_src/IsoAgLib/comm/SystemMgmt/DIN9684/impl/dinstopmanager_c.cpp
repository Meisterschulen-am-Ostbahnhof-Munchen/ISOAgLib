/***************************************************************************
                          dinstopmanager_c.cpp - object which helps managing
...
*/
DINStopManager_c::DINStopManager_c(uint8_t rui8_empf, bool rb_toStop){
  /** set default or given values */
  setEmpf(rui8_empf);
  if (rui8_empf == 0xF) setToStop(0xF);
  else
  {
...
*/
DINStopManager_c::DINStopManager_c(const DINStopManager_c& rrefc_src){
  /** set default or given values */
  setEmpf(rrefc_src.empf());
  setToStop(rrefc_src.toStop());
}
/** default destructor which has nothing to do */
DINStopManager_c::~DINStopManager_c(){
}
