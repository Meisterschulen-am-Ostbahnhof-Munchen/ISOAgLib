/***************************************************************************
                          adrvecttrusted.cpp - from AdrVect_c derived object
...
*/
AdrVectTrusted_c::AdrVectTrusted_c(const uint16_t rui16_adrvect) : AdrVect_c(rui16_adrvect), c_trustedAdrvect(){
}
/** default destructor which has nothing to do */
AdrVectTrusted_c::~AdrVectTrusted_c(){
}
