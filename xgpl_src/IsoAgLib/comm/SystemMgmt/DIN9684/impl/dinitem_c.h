...
public:
  ...
  */
  DINItem_c(int32_t ri32_time = 0, GetyPos_c rc_gtp = GetyPos_c( 0xF, 0xF ), uint8_t rui8_nr = 0xFF, IState_c::itemState_t rb_status = IState_c::IstateNull,
  ...
  */
  ...
  /**
    ...
    @param ri_singletonVecKey optional key for selection of IsoAgLib instance (default 0)
  */
  void set(int32_t ri32_time = 0, GetyPos_c rc_gtp = GetyPos_c(0xF, 0xF), uint8_t rui8_nr = 0xFF, itemState_t ren_status = IState_c::Active,
           uint16_t rui16_adrVect = 0, const uint8_t* rpb_name = NULL, int ri_singletonVecKey = 0 );
