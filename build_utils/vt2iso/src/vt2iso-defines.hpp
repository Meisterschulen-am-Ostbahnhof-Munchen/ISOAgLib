...
#define attrNumber_of_points (70)
#define attrRle (71)
#define attrNumber_of_bytes (72)
//addtional Aux Function/Input Attributes
#define attrFunction_type (73)
#define attrInput_id (74)

// Command Attributes:
#define attrObjectID	(75)
#define attrHideShow	(76)
#define attrDisable_enable (77)
#define attrNumber_of_repetitions (78)
#define attrFrequency (79)
#define attrOnTime_duration (80)
#define attrOffTime_duration (81)
#define attrPercentage (82)
#define attrParent_objectID (83)
#define attrX_change (84)
#define attrY_change (85)
#define attrX_pos (86)
#define attrY_pos (87)
#define attrNew_width (88)
#define attrNew_height (89)
#define attrNew_background_colour (90)
#define attrNew_value (91)
#define attrLine_direction (92)
#define attrWorking_setID (93)
#define attrNew_active_mask (94)
#define attrMask_type (95)
#define attrMaskID (96)
#define attrNew_softkey_mask (97)
#define attrAttributeID (98)
#define attrNew_priority (99)
#define attrList_index (100)
#define attrNew_objectID (101)
#define attrBytes_in_string (102)
#define attrCode (103)

#define maxAttributeNames (104)	
