...
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_ecu_display" 
//            Perform changes direct in the feature and project setup file conf_ecu_display
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_ecu_display" call,
