...
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_ecu_data_source" 
//            Perform changes direct in the feature and project setup file conf_ecu_data_source
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_ecu_data_source" call,
...
#define PRJ_USE_AUTOGEN_CONFIG config_ecuDataSource.h
