// File: config_ecuDataSource.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "conf2build.sh conf_ecu_data_source_win32" 
//            Perform changes direct in the feature and project setup file conf_ecu_data_source_win32
...
//                      All commented out defines in the middle block will be upated on next "conf2build.sh conf_ecu_data_source_win32" call,
...
// These defines are set in the conf_ecu_data_source_win32:
