// File: config_ecuTractorBridge.h
// IMPORTANT: Never change the first block of this header manually!!!
//            All manual changes are overwritten by the next call of "update_makefile.sh conf_ecu_tractor_bridge" 
//            Perform changes direct in the feature and project setup file conf_ecu_tractor_bridge
...
//                      All commented out defines in the middle block will be upated on next "update_makefile.sh conf_ecu_tractor_bridge" call,
...
#define PRJ_USE_AUTOGEN_CONFIG config_ecuTractorBridge.h
